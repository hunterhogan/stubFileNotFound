...
"""
log = ...
__all__ = ["add_dummy_dsig", "drop_mac_cmap", "drop_mac_names", "drop_nonpid0_cmap", "drop_superfluous_mac_names", "fix_ascii_fontmetadata", "fix_family", "fix_filename", "fix_font", "fix_fs_selection", "fix_fs_type", "fix_fvar_instances", "fix_hinted_font", "fix_isFixedPitch", "fix_mac_style", "fix_nametable", "fix_pua", "fix_unhinted_font", "fix_vertical_metrics", "fix_weight_class", "inherit_vertical_metrics", "remove_tables", "rename_font"]
WEIGHT_NAMES = ...
WEIGHT_VALUES = ...
FixResult: TypeAlias = tuple[bool, list[str]]
UNWANTED_TABLES = ...
