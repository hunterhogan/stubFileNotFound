...
class Canvas:
    ...
    def getAvailableFonts(self) -> list[list[Any]]:
        """Returns the list of PostScript font names available.
        Standard set now, but may grow in future with font embedding.
        """

    def addFont(self, psfontname, encoding=..., clientCtx=..., getFontDescriptor=..., getEncodingInfo=...) -> None:
        ...

    def setFont(self, psfontname, size, leading=..., encoding=...) -> None:
...
class PDFPathObject:
    ...
    def getCode(self) -> LiteralString:
...
class PDFTextObject:
    ...
    def getCursor(self) -> tuple[Any, Any]:
