...
@overload
def read(file: str | int | PathLike[Any], frames: int = -1, start: int = 0, stop: int | None = None, dtype: Literal['float64', 'float32', 'int32', 'int16'] = 'float64', always_2d: Literal[True] = True, fill_value: float | None = None, out: numpy.ndarray[tuple[int, int], numpy.dtype[numpy.floating[numpy._typing._32Bit] | numpy.float64 | numpy.int32 | numpy.int16]] | None = None, samplerate: int | None = None, channels: int | None = None, format: str | None = None, subtype: str | None = None, endian: str | None = None, closefd: bool = True) -> tuple[numpy.ndarray[tuple[int, int], numpy.dtype[numpy.floating[numpy._typing._32Bit] | numpy.float64 | numpy.int32 | numpy.int16]], int]:...
@overload
def read(file: str | int | PathLike[Any], frames: int = -1, start: int = 0, stop: int | None = None, dtype: Literal['float64', 'float32', 'int32', 'int16'] = 'float64', always_2d: bool = False, fill_value: float | None = None, out: numpy.ndarray[tuple[int, ...], numpy.dtype[numpy.floating[numpy._typing._32Bit] | numpy.float64 | numpy.int32 | numpy.int16]] | None = None, samplerate: int | None = None, channels: int | None = None, format: str | None = None, subtype: str | None = None, endian: str | None = None, closefd: bool = True) -> tuple[numpy.ndarray[tuple[int, ...], numpy.dtype[numpy.floating[numpy._typing._32Bit] | numpy.float64 | numpy.int32 | numpy.int16]], int]:...

def write(file: str | int | PathLike[Any], data: ArrayLike, samplerate: int, subtype: str | None = None, endian: str | None = None, format: str | None = None, closefd: bool = True, compression_level: float | None = None, bitrate_mode: str | None = None) -> None:...

def blocks(file: str | int | PathLike[Any], blocksize: int | None = None, overlap: int = 0, frames: int = -1, start: int = 0, stop: int | None = None, dtype: str = 'float64', always_2d: bool = False, fill_value: float | None = None, out: numpy.ndarray[tuple[int, ...], numpy.dtype[numpy.floating[numpy._typing._32Bit] | numpy.float64 | numpy.int32 | numpy.int16]] | None = None, samplerate: int | None = None, channels: int | None = None, format: str | None = None, subtype: str | None = None, endian: str | None = None, closefd: bool = True) -> Generator[numpy.ndarray[tuple[int, ...], numpy.dtype[numpy.floating[numpy._typing._32Bit] | numpy.float64 | numpy.int32 | numpy.int16]], None, None]:...
...
class SoundFile:
    ...
    @overload
    def read(self, frames: int = -1, dtype: Literal['float64', 'float32', 'int32', 'int16'] = 'float64', always_2d: Literal[True] = True, fill_value: float | None = None, out: numpy.ndarray[tuple[int, int], numpy.dtype[numpy.floating[numpy._typing._32Bit] | numpy.float64 | numpy.int32 | numpy.int16]] | None = None) -> numpy.ndarray[tuple[int, int], numpy.dtype[numpy.floating[numpy._typing._32Bit] | numpy.float64 | numpy.int32 | numpy.int16]]:...
    @overload
    def read(self, frames: int = -1, dtype: Literal['float64', 'float32', 'int32', 'int16'] = 'float64', always_2d: bool = False, fill_value: float | None = None, out: numpy.ndarray[tuple[int, ...], numpy.dtype[numpy.floating[numpy._typing._32Bit] | numpy.float64 | numpy.int32 | numpy.int16]] | None = None) -> numpy.ndarray[tuple[int, ...], numpy.dtype[numpy.floating[numpy._typing._32Bit] | numpy.float64 | numpy.int32 | numpy.int16]]:...
    ...
    def blocks(self, blocksize: int | None = None, overlap: int = 0, frames: int = -1, dtype: str = 'float64', always_2d: bool = False, fill_value: float | None = None, out: numpy.ndarray[tuple[int, ...], numpy.dtype[numpy.floating[numpy._typing._32Bit] | numpy.float64 | numpy.int32 | numpy.int16]] | None = None) -> Generator[numpy.ndarray[tuple[int, ...], numpy.dtype[numpy.floating[numpy._typing._32Bit] | numpy.float64 | numpy.int32 | numpy.int16]], Any, None]:...
    ...
    def _create_empty_array(self, frames: int, always_2d: bool, dtype: str) -> numpy.ndarray[tuple[int, ...], numpy.dtype[numpy.floating[numpy._typing._32Bit] | numpy.float64 | numpy.int32 | numpy.int16]]:...

    def _check_dtype(self, dtype: str) -> str:...

    def _array_io(self, action: str, array: numpy.ndarray[tuple[int, ...], numpy.dtype[numpy.floating[numpy._typing._32Bit] | numpy.float64 | numpy.int32 | numpy.int16]], frames: int) -> int:...
