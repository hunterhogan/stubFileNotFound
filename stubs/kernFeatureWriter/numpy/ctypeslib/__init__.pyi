...
from numpy import byte, double, dtype, generic, intc, long, longdouble, longlong, ndarray, short, single, ubyte, uintc, ulong, ulonglong, ushort, void
from numpy._core._internal import _ctypes
from numpy._core.multiarray import flagsobj
from numpy._typing import DTypeLike, NDArray, _AnyShape, _ArrayLike, _BoolCodes, _ByteCodes, _DTypeLike, _DoubleCodes, _IntCCodes, _LongCodes, _LongDoubleCodes, _LongLongCodes, _ShapeLike, _ShortCodes, _SingleCodes, _UByteCodes, _UIntCCodes, _ULongCodes, _ULongLongCodes, _UShortCodes, _VoidDTypeLike
...
_FlagsKind: TypeAlias = L["C_CONTIGUOUS", "CONTIGUOUS", "C", "F_CONTIGUOUS", "FORTRAN", "F", "ALIGNED", "A", "WRITEABLE", "W", "OWNDATA", "O", "WRITEBACKIFCOPY", "X",]
...
c_intp = _c_intp
@overload
def ndpointer(dtype: None = ..., ndim: int | None = ..., shape: _ShapeLike | None = ..., flags: _FlagsKind | Iterable[_FlagsKind] | int | flagsobj | None = ...) -> type[_ndptr[None]]:
    ...

@overload
def ndpointer(dtype: _DTypeLike[_ScalarT], ndim: int | None = ..., *, shape: _ShapeLike, flags: _FlagsKind | Iterable[_FlagsKind] | int | flagsobj | None = ...) -> type[_concrete_ndptr[dtype[_ScalarT]]]:
    ...

@overload
def ndpointer(dtype: DTypeLike | None, ndim: int | None = ..., *, shape: _ShapeLike, flags: _FlagsKind | Iterable[_FlagsKind] | int | flagsobj | None = ...) -> type[_concrete_ndptr[dtype]]:
    ...

@overload
def ndpointer(dtype: _DTypeLike[_ScalarT], ndim: int | None = ..., shape: None = ..., flags: _FlagsKind | Iterable[_FlagsKind] | int | flagsobj | None = ...) -> type[_ndptr[dtype[_ScalarT]]]:
    ...

@overload
def ndpointer(dtype: DTypeLike | None, ndim: int | None = ..., shape: None = ..., flags: _FlagsKind | Iterable[_FlagsKind] | int | flagsobj | None = ...) -> type[_ndptr[dtype]]:
    ...
