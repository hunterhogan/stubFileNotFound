...
class PandasDelegate:
    ...
    @classmethod
    def _add_delegate_accessors(cls, delegate, accessors: list[str], typ: str, overwrite: bool = False, accessor_mapping: Callable[[str], str] = ..., raise_on_missing: bool = True) -> None:
        """
