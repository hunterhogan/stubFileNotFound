...
class DataFrame(NDFrame, OpsMixin, _GetItemHack):
    ...
    @overload
    def stack(
        self, level: Level | list[Level] = -1, dropna: _bool = ..., sort: _bool = ...
    ) -> Self | Series[Any]: ...
    @overload
    def stack(
        self, level: Level | list[Level] = -1, future_stack: _bool = False
    ) -> Self | Series[Any]: ...
    def explode(
    ...
    def astype(
        self,
        dtype: AstypeArg | Mapping[Any, Dtype] | Series[Dtype],
        copy: _bool = ...,
        errors: IgnoreRaise = ...,
    ) -> Self: ...
    def at_time(
