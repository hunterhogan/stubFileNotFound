...
class CategoricalDtype(PandasExtensionDtype, ExtensionDtype):
    def __init__(
        self,
        categories: Series | Index[Any] | list[Any] | None = None,
...
class DatetimeTZDtype(PandasExtensionDtype):
    def __init__(self, unit: Literal["ns"] = "ns", tz: TimeZones = None) -> None: ...
    @property
...
class IntervalDtype(PandasExtensionDtype):
    def __init__(self, subtype: str | npt.DTypeLike | None = None) -> None: ...
    @property
