...
class Categorical(ExtensionArray):
    ...
    def reorder_categories(
        self, new_categories: Any, ordered: bool | None = ...
    ) -> Categorical: ...
    ...
    @property
    def shape(self) -> Any: ...
    def shift(self, periods: Any=1, fill_value: Any=...) -> Any: ...
    def __array__(
    ...
    def argsort(self, *, ascending: bool = ..., kind: str = ..., **kwargs: Any) -> Any: ...
    def sort_values(
        self, *, inplace: bool = ..., ascending: bool = ..., na_position: str = ...
    ) -> Any: ...
    def view(self, dtype: Any=...) -> Any: ...
    def take(
        self, indexer: TakeIndexer, *, allow_fill: bool = ..., fill_value: Any=...
    ) -> Categorical: ...
