...
class IntervalArray(IntervalMixin, ExtensionArray):
    can_hold_na: bool = ...
    def __new__(
        cls, data, closed=None, dtype=None, copy: bool = False, verify_integrity: bool = True
    ): ...
    @classmethod
    def from_breaks(cls, breaks, closed: str = 'right', copy: bool = False, dtype=None): ...
    @classmethod
    def from_arrays(
        cls, left, right, closed: str = 'right', copy: bool = False, dtype=None
    ): ...
    @classmethod
    def from_tuples(cls, data, closed: str = 'right', copy: bool = False, dtype=None): ...
    def __iter__(self): ...
