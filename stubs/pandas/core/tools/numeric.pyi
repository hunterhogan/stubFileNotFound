...
from pandas._libs.lib import is_decimal as is_decimal, is_scalar as is_scalar
...
from pandas.core.dtypes.common import is_bool_dtype as is_bool_dtype, is_integer_dtype as is_integer_dtype, is_numeric_dtype as is_numeric_dtype, is_string_dtype as is_string_dtype, needs_i8_conversion as needs_i8_conversion
...
TYPE_CHECKING: bool
def to_numeric(arg, errors: DateTimeErrorChoices = ..., downcast: Literal['integer', 'signed', 'unsigned', 'float'] | None, dtype_backend: DtypeBackend | lib.NoDefault = ...):
    '''
