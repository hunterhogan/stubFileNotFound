...
@overload
def array(
    data: Sequence[Any] | np_ndarray | ExtensionArray | Index[Any] | Series,
...
def array(
    ...
    data: Categorical | CategoricalIndex[Any],
...
@overload
def array(  # type: ignore[overload-overlap]
    data: Sequence[IntervalT | None] | IntervalArray | IntervalIndex[Any] | Series[Interval[Any]],
    dtype: None = None,
    copy: bool = True,
) -> IntervalArray: ...
@overload
