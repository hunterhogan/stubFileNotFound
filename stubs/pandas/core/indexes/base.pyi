...
class Index(IndexOpsMixin, PandasObject):
    ...
    names: Incomplete
    @overload
    def set_names(self, names, *, level=..., inplace: Literal[False] = False) -> Self: ...
    @overload
    ...
    @overload
    def join(self, other: Index, *, how: JoinHow = ..., level: Level = ..., return_indexers: Literal[False] = False, sort: bool = ...) -> Index: ...
    @overload
    ...
    def _raise_if_missing(self, key, indexer, axis_name: str_t) -> None:
        ...
        """
    @overload
    def _get_indexer_non_comparable(self, target: Index, method, unique: Literal[True] = True) -> npt.NDArray[np.intp]: ...
    @overload
