...
class MultiIndex(Index[Any]):
    ...
    def set_levels(self, levels: Any, *, level: Any=..., verify_integrity: bool = ...) -> Any: ...
    @property
    def codes(self) -> Any: ...
    def set_codes(self, codes: Any, *, level: Any=..., verify_integrity: bool = ...) -> Any: ...
    ...
    def droplevel(self, level: Level | Sequence[Level] = 0) -> MultiIndex | Index[Any]: ...  # type: ignore[override]
    ...
    def to_flat_index(self) -> Index[Any]: ...
