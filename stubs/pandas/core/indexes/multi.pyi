...
class MultiIndex(Index[Any]):
    ...
    def levels(self) -> FrozenList[Index[Any]]: ...
    @overload
    def set_levels(
        self,
    ...
    def droplevel(self, level: Level | Sequence[Level] = 0) -> MultiIndex | Index[Any]: ...  # type: ignore[override] # pyrefly: ignore[bad-override]
    ...
    def append(  # pyright: ignore[reportIncompatibleMethodOverride]
        self, other: Index[Any] | Sequence[Index[Any]]
    ) -> Index[Any]: ...
    ...
    ) -> tuple[int | slice | np_1darray_bool, Index[Any]]: ...
