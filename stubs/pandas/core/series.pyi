...
class Series(IndexOpsMixin[S1], ElementOpsMixin[S1], NDFrame):
    ...
    @overload
    def unique(self: Series[Never]) -> np.ndarray[Any, Any]: ...  # type: ignore[overload-overlap]
    @overload
    ...
    @overload
    def diff(
        self: SupportsGetItem[Scalar, SupportsSelfSub[S2]], periods: int = 1
    ) -> Series[S2]: ...
    ...
    @overload
    def __add__(
        self: Series[Never], other: complex | _ListLike | Index[Any] | Series
    ) -> Series: ...
    @overload
    ...
    def add(
        self: Series[Never],
        other: complex | _ListLike | Index[Any] | Series,
        level: Level | None = None,
