...
TYPE_CHECKING: bool
def hist_series(self: Series, by, ax, grid: bool = ..., xlabelsize: int | None, xrot: float | None, ylabelsize: int | None, yrot: float | None, figsize: tuple[int, int] | None, bins: int | Sequence[int] = ..., backend: str | None, legend: bool = ..., **kwargs):
    """
    ...
    **kwargs
    ...
    """
def hist_frame(data: DataFrame, column: IndexLabel | None, by, grid: bool = ..., xlabelsize: int | None, xrot: float | None, ylabelsize: int | None, yrot: float | None, ax, sharex: bool = ..., sharey: bool = ..., figsize: tuple[int, int] | None, layout: tuple[int, int] | None, bins: int | Sequence[int] = ..., backend: str | None, legend: bool = ..., **kwargs):
    """
...
def boxplot(data: DataFrame, column: str | list[str] | None, by: str | list[str] | None, ax: Axes | None, fontsize: float | str | None, rot: int = ..., grid: bool = ..., figsize: tuple[float, float] | None, layout: tuple[int, int] | None, return_type: str | None, **kwargs):
    """
    ...
    * :class:`~numpy.array` (for ``return_type = None``)
    ...
    as ``layout`` is returned:
        ...
        <class 'numpy.ndarray'>
    """
def boxplot_frame(self: DataFrame, column, by, ax, fontsize: int | None, rot: int = ..., grid: bool = ..., figsize: tuple[float, float] | None, layout, return_type, backend, **kwargs):
    """
    Make a box plot from DataFrame columns.
    ...
    * :class:`~numpy.array` (for ``return_type = None``)
    ...
    as ``layout`` is returned:
        ...
        <class 'numpy.ndarray'>
    """
def boxplot_frame_groupby(grouped: DataFrameGroupBy, subplots: bool = ..., column, fontsize: int | None, rot: int = ..., grid: bool = ..., ax, figsize: tuple[float, float] | None, layout, sharex: bool = ..., sharey: bool = ..., backend, **kwargs):
    """
...
class PlotAccessor(pandas.core.base.PandasObject):
    _common_kinds: ClassVar[tuple] = ...
    _series_kinds: ClassVar[tuple] = ...
    _dataframe_kinds: ClassVar[tuple] = ...
    _kind_aliases: ClassVar[dict] = ...
    _all_kinds: ClassVar[tuple] = ...
    ...
    def kde(self, bw_method: Literal['scott', 'silverman'] | float | Callable | None, ind: np.ndarray | int | None, **kwargs) -> PlotAccessor:
        ...
        **kwargs
        ...
        """
    def density(self, bw_method: Literal['scott', 'silverman'] | float | Callable | None, ind: np.ndarray | int | None, **kwargs) -> PlotAccessor:
        """
        Generate Kernel Density Estimate plot using Gaussian kernels.
...
def _load_backend(backend: str) -> types.ModuleType:
    ...
    '''
def _get_plot_backend(backend: str | None):
    """
