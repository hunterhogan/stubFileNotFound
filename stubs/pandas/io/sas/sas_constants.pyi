...
compression_literals: list
encoding_names: dict

class SASIndex:
    row_size_index: ClassVar[int] = ...
    column_size_index: ClassVar[int] = ...
    subheader_counts_index: ClassVar[int] = ...
    column_text_index: ClassVar[int] = ...
    column_name_index: ClassVar[int] = ...
    column_attributes_index: ClassVar[int] = ...
    format_and_label_index: ClassVar[int] = ...
    column_list_index: ClassVar[int] = ...
    data_subheader_index: ClassVar[int] = ...
subheader_signature_to_index: dict
sas_date_formats: tuple
sas_datetime_formats: tuple
