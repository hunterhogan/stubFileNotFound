...
class NAType:
    ...
    @overload
    def __add__(self, other: Index[Any], /) -> Index[Any]: ...
    @overload
    ...
    @overload
    def __pow__(self, other: Index[Any], /) -> Index[Any]: ...
    @overload
    def __pow__(self, other: complex, /) -> NAType: ...
    @overload
    def __rpow__(self, other: Series, /) -> Series: ...
    @overload
    def __rpow__(self, other: Index[Any], /) -> Index[Any]: ...
    @overload
    ...
    @overload
    def __xor__(self, other: Index[Any], /) -> Index[Any]: ...
    @overload
    def __xor__(self, other: bool | np.bool, /) -> NAType: ...
    @overload
    def __rxor__(self, other: Series, /) -> Series: ...
    @overload
    def __rxor__(self, other: Index[Any], /) -> Index[Any]: ...
    @overload
