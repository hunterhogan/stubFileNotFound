...
if False:
    ...
__all__ = ['BaseConstructor', 'Constructor', 'ConstructorError', 'RoundTripConstructor', 'SafeConstructor']
...
class BaseConstructor:
    ...
    def __init__(self, preserve_quotes: Optional[bool] = ..., loader: Any = ...) -> None:
        ...
    ...
    def construct_non_recursive_object(self, node: Any, tag: Optional[str] = ...) -> Any:
        ...
...
class Constructor(SafeConstructor):
    ...
    def make_python_instance(self, suffix: Any, node: Any, args: Any = ..., kwds: Any = ..., newobj: bool = ...) -> Any:
        ...
    ...
    def construct_python_object_apply(self, suffix: Any, node: Any, newobj: bool = ...) -> Any:
        ...
...
class RoundTripConstructor(SafeConstructor):
    ...
    def construct_rt_sequence(self, node: Any, seqtyp: Any, deep: bool = ...) -> Any:
        ...
