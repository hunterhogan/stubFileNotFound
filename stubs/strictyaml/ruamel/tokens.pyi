...
class Token:
    ...
    def move_comment(self, target: Any, empty: bool = ...) -> Any:
...
class StreamStartToken(Token):
    __slots__ = ...
    id = ...
    def __init__(self, start_mark: Any = ..., end_mark: Any = ..., encoding: Any = ...) -> None:
        ...
...
class ScalarToken(Token):
    __slots__ = ...
    id = ...
    def __init__(self, value: Any, plain: Any, start_mark: Any, end_mark: Any, style: Any = ...) -> None:
        ...
