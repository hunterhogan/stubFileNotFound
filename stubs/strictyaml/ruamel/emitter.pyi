...
class Emitter:
    ...
    def __init__(self, stream: StreamType, canonical: Any = ..., indent: Optional[int] = ..., width: Optional[int] = ..., allow_unicode: Optional[bool] = ..., line_break: Any = ..., block_seq_indent: Optional[int] = ..., top_level_colon_align: Optional[bool] = ..., prefix_colon: Any = ..., brace_single_entry_mapping_in_flow_sequence: Optional[bool] = ..., dumper: Any = ...) -> None:
        ...
    ...
    def increase_indent(self, flow: bool = ..., sequence: Optional[bool] = ..., indentless: bool = ...) -> None:
        ...
    ...
    def expect_flow_mapping(self, single: Optional[bool] = ...) -> None:
        ...
    ...
    def write_indicator(self, indicator: Any, need_whitespace: Any, whitespace: bool = ..., indention: bool = ...) -> None:
        ...
