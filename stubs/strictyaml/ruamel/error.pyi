...
if False:
    ...
__all__ = ["CommentMark", "FileMark", "MarkedYAMLError", "MarkedYAMLFutureWarning", "MarkedYAMLWarning", "ReusedAnchorWarning", "StringMark", "UnsafeLoaderWarning", "YAMLError"]
class StreamMark:
    __slots__ = ...
...
class MarkedYAMLError(YAMLError):
    def __init__(self, context: Any = ..., context_mark: Any = ..., problem: Any = ..., problem_mark: Any = ..., note: Any = ..., warn: Any = ...) -> None:
        ...
