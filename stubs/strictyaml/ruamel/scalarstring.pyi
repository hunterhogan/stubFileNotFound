...
if False:
    ...
__all__ = ["DoubleQuotedScalarString", "FoldedScalarString", "LiteralScalarString", "PlainScalarString", "PreservedScalarString", "ScalarString", "SingleQuotedScalarString"]
class ScalarString(text_type):
    __slots__ = ...
    def __new__(cls, *args: Any, **kw: Any) -> Any:
        ...

    def replace(self, old: Any, new: Any, maxreplace: int = ...) -> Any:
        ...
