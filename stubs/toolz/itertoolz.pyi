...
def merge_sorted(*seqs, **kwargs):
    ...
    [2, 1, 3, 3]
    '''
def interleave(seqs) -> Generator[Incomplete]:
    ...
    """
def unique(seq, key: Incomplete | None = None) -> Generator[Incomplete]:
...
def reduceby(key, binop, seq, init='__no__default__'):
    ...
    {True:  set([2, 4]),
     False: set([1, 3])}
    """
def iterate(func, x) -> Generator[Incomplete]:
...
def partition(n, seq, pad='__no__pad__'):
    ...
    See Also:
        partition_all
    """
def partition_all(n, seq) -> Generator[Incomplete]:
...
def join(leftkey, leftseq, rightkey, rightseq, left_default='__no__default__', right_default='__no__default__') -> Generator[Incomplete]:
    ...
    """
def diff(*seqs, **kwargs) -> Generator[Incomplete]:
