...
def _to_designspace_varfont(self, instance) -> None: ...
def _to_designspace_instance(self, instance, ignore_disabled_cp: bool = False) -> None: ...
def _to_custom_parameters(instance, ignore_disabled: bool = False): ...
...
class InstanceDescriptorAsGSInstance:
    ...
    """
    _descriptor: Incomplete
    customParameters: Incomplete
    properties: Incomplete
    def __init__(self, descriptor) -> None: ...

def _set_class_from_instance(ufo, designspace, instance, axis_tag) -> None: ...
