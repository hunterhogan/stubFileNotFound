...
class ParamHandler(AbstractParamHandler):
    ...
    def _write_to_glyphs(self, glyphs, value) -> None: ...
    def _read_from_ufo(self, glyphs, ufo): ...
    def _write_to_ufo(self, glyphs, ufo, value) -> None: ...
...
def _set_default_params(ufo) -> None:
    """Set Glyphs.app's default parameters when different from ufo2ft ones."""
def _unset_default_params(glyphs) -> None:
