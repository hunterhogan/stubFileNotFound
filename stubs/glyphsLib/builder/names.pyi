from .constants import GLYPHS_PREFIX as GLYPHS_PREFIX

def to_ufo_names(self, ufo, master, family_name) -> None: ...
def to_ufo_names_roundtrip(master, ufo) -> None: ...
def build_stylemap_names(family_name, style_name, is_bold: bool = False, is_italic: bool = False, linked_style=None):
    ...
    '''
def to_glyphs_family_names(self, ufo, merge: bool = False) -> None: ...
