...
from glyphsLib.util import LoggerMixin as LoggerMixin, _DeprecatedArgument as _DeprecatedArgument
...
class UFOBuilder(LoggerMixin):
    ...
    _sources: Incomplete
    _layer_map: Incomplete
    _color_palette_layers: Incomplete
    _color_layers: Incomplete
    _glyph_sets: dict[str, dict[str, classes.GSLayer]]
    _designspace: Incomplete
    _designspace_is_complete: bool
    is_vertical: Incomplete
    alternate_names_map: Incomplete
    family_name: Incomplete
    _do_filter_instances_by_family: bool
