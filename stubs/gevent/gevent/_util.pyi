...
def update_wrapper(wrapper: _T, wrapped: object, assigned: Sequence[str] = ('__module__', '__name__', '__qualname__', '__doc__', '__annotations__'), updated: Sequence[str] = ('__dict__',)) -> _T: ...
def copy_globals(
    source: ModuleType,
