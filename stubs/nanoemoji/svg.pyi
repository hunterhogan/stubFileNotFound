...
from typing import ClassVar, NamedTuple, Optional, TypeAlias, Union
import dataclasses
...
_GradientPaint: TypeAlias = PaintLinearGradient | PaintRadialGradient
...
class ReuseCache:
    ...
    def add_glyph(self, glyph_name: str, context: SVGTraverseContext, reuse_result: ReuseResult | None = ...): # -> None:
        ...
