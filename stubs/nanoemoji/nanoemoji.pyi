...
def write_compressed_bitmap_builds(builds: set[Path], resolutions: set[int], nw: NinjaWriter, master: MasterConfig, rule_name: str, dest_dir: Path, infile_fn: Callable[[Path, int], Path], outfile_fn: Callable[[Path, int], Path], variables: Mapping[str, Any] | None = ...): # -> None:
    ...
