...
class rrulewrapper:
    ...
    _tzinfo: Incomplete
    _rrule: Incomplete
    def _update_rrule(self, **kwargs) -> None: ...
    def _attach_tzinfo(self, dt, tzinfo): ...
    def _aware_return_wrapper(self, f, returns_list: bool = False):
...
class ConciseDateConverter(DateConverter):
    _formats: Incomplete
    _zero_formats: Incomplete
    _offset_formats: Incomplete
    _show_offset: Incomplete
    _interval_multiples: Incomplete
