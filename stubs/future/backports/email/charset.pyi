...
class Charset:
    ...
    def get_body_encoding(self): # -> Callable[..., None] | Literal['quoted-printable', 'base64']:
    ...
    def header_encode_lines(self, string, maxlengths): # -> list[Any]:
        """Header-encode a string by converting it first to bytes.
    ...
    def body_encode(self, string): # -> newstr:
