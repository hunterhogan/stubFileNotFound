...
class cpu_timed_scope(scope):
    ...
    """
    def __init__(self, name: str, metrics: Optional[dict[str, float]] = ...) -> None:
        ...
    


def enter_scope(name: str, *, metrics: Optional[dict[str, MetricValueType]] = ...) -> Optional[int]:
    ...

def exit_scope(name: Optional[str] = ..., *, metrics: Optional[dict[str, MetricValueType]] = ...) -> Optional[int]:
    ...
