...
def start(name: Optional[str] = ..., *, context: Optional[str] = ..., data: Optional[str] = ..., backend: Optional[str] = ..., mode: Optional[Union[str, BaseMode]] = ..., hook: Optional[str] = ...): # -> None:
    """
...
def finalize(session: Optional[int] = ..., output_format: Optional[str] = ...) -> None:
    """
...
def profile(func=..., *, name: Optional[str] = ..., context: Optional[str] = ..., data: Optional[str] = ..., backend: Optional[str] = ..., mode: Optional[str] = ..., hook: Optional[str] = ...): # -> Callable[..., _Wrapped[Callable[..., Any], Any, Callable[..., Any], Any]] | _Wrapped[Callable[..., Any], Any, Callable[..., Any], Any]:
    """
