...
def start(name: str | None = ..., *, context: str | None = ..., data: str | None = ..., backend: str | None = ..., mode: str | BaseMode | None = ..., hook: str | None = ...): # -> None:
    """
...
def profile(func=..., *, name: str | None = ..., context: str | None = ..., data: str | None = ..., backend: str | None = ..., mode: str | None = ..., hook: str | None = ...): # -> Callable[..., _Wrapped[Callable[..., Any], Any, Callable[..., Any], Any]] | _Wrapped[Callable[..., Any], Any, Callable[..., Any], Any]:
    """
