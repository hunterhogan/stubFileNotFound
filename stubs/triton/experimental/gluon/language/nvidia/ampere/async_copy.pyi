...
__all__ = ["async_copy_global_to_shared", "mbarrier_arrive", "commit_group", "wait_group"]
@builtin
def async_copy_global_to_shared(smem, pointer, mask=..., cache_modifier=..., eviction_policy=..., volatile=..., _semantic=...): # -> None:
    """
