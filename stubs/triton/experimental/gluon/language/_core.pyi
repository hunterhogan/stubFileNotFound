...
if TYPE_CHECKING:
    ...
__all__ = ["constexpr", "pointer_type", "void", "int1", "int8", "int16", "int32", "int64", "uint8", "uint16", "uint32", "uint64", "float8e5", "float8e5b16", "float8e4nv", "float8e4b8", "float8e4b15", "float16", "bfloat16", "float32", "float64", "distributed_type", "shared_memory_descriptor_type", "static_range", "tuple", "tuple_type", "num_ctas"]
T = TypeVar("T")
GLUON_BUILTIN = ...
def builtin(fn: T) -> T:
