...
from typing import Any, Callable, Generator, Generic, Optional, Protocol, TYPE_CHECKING, Type, TypeVar, TypedDict, Union
...
class CompilationListener(Protocol):
    def __call__(self, *, src: Union[ASTSource, IRSource], metadata: dict[str, Any], metadata_group: dict[str, str], times: CompileTimes, cache_hit: bool) -> None:
        ...
...
class BuildImpl(Protocol):
    def __call__(self, name: str, src: str, srcdir: str, library_dirs: list[str], include_dirs: list[str], libraries: list[str], /) -> str:
        ...
...
class compilation_knobs(base_knobs):
    override: env_bool = ...
    dump_ir: env_bool = ...
    dump_ir_extract_di_local_variables: env_bool = ...
...
class InitHandleHook(Protocol):
    ...
    """
    def __call__(self, module: Optional[object], function: Optional[Callable], name: str, metadata_group: dict[str, str], hash: str) -> None:
        ...
...
class JITHook(Protocol):
    def __call__(self, *, key: str, repr: str, fn: JitFunctionInfo, compile: JITHookCompileInfo, is_manual_warmup: bool, already_compiled: bool) -> Optional[bool]:
        ...
    


class PipelineStagesHook(Protocol):
    def __call__(self, stages, options, language, capability): # -> None:
        ...
...
class runtime_knobs(base_knobs):
    ...
    jit_cache_hook: Optional[JITHook] = ...
    jit_post_compile_hook: Optional[JITHook] = ...
    add_stages_inspection_hook: Optional[PipelineStagesHook] = ...
...
class nvidia_knobs(base_knobs):
    ...
    ptxas_blackwell: env_nvidia_tool = ...
    dump_nvptx: env_bool = ...
    disable_ptxas_opt: env_bool = ...
    ptxas_options: env_opt_str = ...
...
class amd_knobs(base_knobs):
    ...
    buffer_ops_analyze_small_tensor_range: env_bool = ...
...
class proton_knobs(base_knobs):
    disable: env_bool = ...
    cupti_lib_dir: env_str = ...
    enable_nvtx: env_bool = ...
