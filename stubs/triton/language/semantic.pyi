...
class TritonSemantic(Generic[TensorTy]):
    ...
    def computation_type_impl(self, a_ty: tl.dtype, a_is_scalar: bool, b_ty: tl.dtype, b_is_scalar: bool, div_or_mod: bool) -> tl.dtype:
        ...
    ...
    def binary_op_type_checking_impl(self, lhs: TensorTy | numbers.Number, rhs: TensorTy | numbers.Number, allow_lhs_ptr=..., allow_rhs_ptr=..., arithmetic_check=..., div_or_mod=...) -> tuple[TensorTy, TensorTy]:
        ...

    def binary_op_sanitize_overflow_impl(self, lhs: TensorTy, rhs: TensorTy, binary_op: callable): # -> None:
        ...

    def add(self, input: TensorTy | numbers.Number, other: TensorTy | numbers.Number, sanitize_overflow: bool) -> TensorTy:
        ...

    def sub(self, input: TensorTy | numbers.Number, other: TensorTy | numbers.Number, sanitize_overflow: bool) -> TensorTy:
        ...

    def mul(self, input: TensorTy | numbers.Number, other: TensorTy | numbers.Number, sanitize_overflow: bool) -> TensorTy:
        ...
    ...
    def load(self, ptr: TensorTy, mask: TensorTy | None, other: TensorTy | None, boundary_check: tuple, padding_option: str, cache_modifier: str, eviction_policy: str, is_volatile: bool) -> TensorTy:
        ...

    def descriptor_load(self, desc: tl.tensor_descriptor_base, offsets, cache_modifier: str, eviction_policy: str) -> TensorTy:
        ...
    ...
    def store(self, ptr: TensorTy, val: TensorTy, mask: TensorTy | None, boundary_check, cache_modifier: str, eviction_policy: str) -> TensorTy:
        ...

    def atomic_cas(self, ptr: TensorTy, cmp: TensorTy, val: TensorTy, sem: str, scope: str) -> TensorTy:
        ...

    def atom_red_typechecking_impl(self, ptr: TensorTy, val: TensorTy, mask: TensorTy, op: str) -> tuple[TensorTy, TensorTy, TensorTy]:
        ...
    ...
    def dot(self, lhs: TensorTy, rhs: TensorTy, acc: TensorTy, input_precision: str | None, max_num_imprecise_acc: int, out_dtype: tl.dtype) -> TensorTy:
        ...

    def verify_scaled_shape(self, M, N, K, lhs_scale, rhs_scale): # -> None:
        ...

    def dot_scaled(self, lhs: TensorTy, lhs_scale: TensorTy, lhs_format: str, rhs: TensorTy, rhs_scale: TensorTy | None, rhs_format: str, acc: TensorTy | None, fast_math: bool, lhs_k_pack: bool, rhs_k_pack: bool, out_dtype: tl.dtype) -> TensorTy:
        ...
    ...
    def map_elementwise(self, inputs: Sequence[tl.tensor], result_types: Sequence[tl.dtype], pack: int, region_builder_fn) -> tuple[tl.tensor, ...]:
        ...
    ...
    def make_tensor_descriptor(self, base: TensorTy, shape: list[TensorTy], strides: list[TensorTy], block_shape: list[tl.constexpr], padding_option: str = ...) -> tl.tensor_descriptor:
        ...
