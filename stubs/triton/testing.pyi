...
class Benchmark:
    ...
    """
    def __init__(self, x_names: List[str], x_vals: List[Any], line_arg: str, line_vals: List[Any], line_names: List[str], plot_name: str, args: Dict[str, Any], xlabel: str = ..., ylabel: str = ..., x_log: bool = ..., y_log: bool = ..., styles=...) -> None:
        """
        Constructor.
...
def cuda_memcheck(**target_kwargs): # -> Callable[..., _Wrapped[Callable[..., Any], Any, Callable[..., Any], None]]:
    ...
