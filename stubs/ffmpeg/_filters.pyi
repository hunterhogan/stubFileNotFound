...
from .nodes import filter_operator

@filter_operator()
def filter_multi_output(stream_spec, filter_name, *args, **kwargs): # -> FilterNode:
...
@filter_operator()
def overlay(main_parent_node, overlay_parent_node, eof_action=..., **kwargs):
...
@filter_operator()
def drawbox(stream, x, y, width, height, color, thickness=..., **kwargs):
...
@filter_operator()
def drawtext(stream, text=..., x=..., y=..., escape_text=..., **kwargs):
...
__all__ = ['colorchannelmixer', 'concat', 'crop', 'drawbox', 'drawtext', 'filter', 'filter_', 'filter_multi_output', 'hflip', 'hue', 'overlay', 'setpts', 'trim', 'vflip', 'zoompan']
