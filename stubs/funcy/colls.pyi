...
FACTORY_REPLACE = ...
def empty(coll) -> Iterator[Any] | Any | defaultdict[Any, Any] | dict[Any, Any] | list[Any]:
...
def join(colls) -> LiteralString | chain[Any] | None:
    """Joins several collections of same type into one."""
    ...

def merge(*colls) -> LiteralString | chain[Any] | None:
...
def join_with(f, dicts, strict: bool = False) -> dict[Any, Any]:
    """Joins several dicts, combining values with given function."""
    ...

def merge_with(f, *dicts) -> dict[Any, Any]:
    """Merges several dicts, combining values with given function."""
    ...

def walk(f, coll) -> Any | defaultdict[Any, Any] | dict[Any, Any] | list[Any] | map[Any]:
    """Walks the collection transforming its elements with f.
       Same as map, but preserves coll type."""
    ...

def walk_keys(f, coll) -> Any | defaultdict[Any, Any] | dict[Any, Any] | list[Any] | map[Any]:
    """Walks keys of the collection, mapping them with f."""
    ...

def walk_values(f, coll) -> Any | defaultdict[Any, Any] | dict[Any, Any] | list[Any] | map[Any]:
    """Walks values of the collection, mapping them with f."""
    ...

def select(pred, coll) -> Any | defaultdict[Any, Any] | dict[Any, Any] | list[Any] | filter[Any]:
    """Same as filter but preserves coll type."""
    ...

def select_keys(pred, coll) -> Any | defaultdict[Any, Any] | dict[Any, Any] | list[Any] | filter[Any]:
    """Select part of the collection with keys passing pred."""
    ...

def select_values(pred, coll) -> Any | defaultdict[Any, Any] | dict[Any, Any] | list[Any] | filter[Any]:
    """Select part of the collection with values passing pred."""
    ...

def compact(coll) -> Any | defaultdict[Any, Any] | dict[Any, Any] | list[Any] | filter[Any]:
    """Removes falsy values from the collection."""
    ...

def is_distinct(coll, key=...) -> bool:
    """Checks if all elements in the collection are different."""
    ...

def all(pred, seq=...) -> bool:
    """Checks if all items in seq pass pred (or are truthy)."""
    ...

def any(pred, seq=...) -> bool:
    """Checks if any item in seq passes pred (or is truthy)."""
    ...

def none(pred, seq=...) -> bool:
    """"Checks if none of the items in seq pass pred (or are truthy)."""
    ...

def one(pred, seq=...) -> bool:
...
def zipdict(keys, vals) -> dict[Any, Any]:
    """Creates a dict with keys mapped to the corresponding vals."""
    ...

def flip(mapping) -> Any | defaultdict[Any, Any] | dict[Any, Any] | list[Any] | map[Any]:
    """Flip passed dict or collection of pairs swapping its keys and values."""
    ...

def project(mapping, keys) -> Any | defaultdict[Any, Any] | dict[Any, Any] | list[Any] | Generator[tuple[Any, Any], None, None]:
    """Leaves only given keys in mapping."""
    ...

def omit(mapping, keys) -> Any | defaultdict[Any, Any] | dict[Any, Any] | list[Any] | Generator[tuple[Any, Any], None, None]:
    """Removes given keys from mapping."""
def zip_values(*dicts) -> Generator[tuple[Any, ...]]:
    """Yields tuples of corresponding values of several dicts."""
def zip_dicts(*dicts) -> Generator[tuple[Any, tuple[Any, ...]]]:
    """Yields tuples like (key, (val1, val2, ...))
       for each common key in all given dicts."""
    ...

def get_in(coll, path, default=None) -> None:
...
def set_in(coll, path, value) -> list[Any]:
    """Creates a copy of coll with the value set at path."""
    ...

def update_in(coll, path, update, default=None) -> list[Any]:
