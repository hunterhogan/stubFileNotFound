...
__all__ = ['all', 'any', 'compact', 'del_in', 'empty', 'flip', 'get_in', 'get_lax', 'has_path', 'invoke', 'is_distinct', 'iteritems', 'itervalues', 'join', 'join_with', 'linvoke', 'lpluck', 'lpluck_attr', 'lwhere', 'merge', 'merge_with', 'none', 'omit', 'one', 'pluck', 'pluck_attr', 'project', 'select', 'select_keys', 'select_values', 'set_in', 'some', 'update_in', 'walk', 'walk_keys', 'walk_values', 'where', 'zip_dicts', 'zip_values', 'zipdict']
FACTORY_REPLACE = ...
