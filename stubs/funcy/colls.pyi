...
def join_with(f, dicts, strict=...): # -> dict[Any, Any]:
...
def zip_values(*dicts): # -> Generator[tuple[Any, ...], Any, None]:
    """Yields tuples of corresponding values of several dicts."""
    ...

def zip_dicts(*dicts): # -> Generator[tuple[Any, tuple[Any, ...]], Any, None]:
...
def update_in(coll, path, update, default=...): # -> list[Any]:
