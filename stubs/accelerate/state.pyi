...
class PartialState:
    ...
    **Available attributes:**
    ...
    @contextmanager
    def split_between_processes(self, inputs: list | tuple | dict | torch.Tensor, apply_padding: bool = ...): # -> Generator[list[Any] | tuple[Any, ...] | dict[Any, Any] | Tensor | Any | Mapping[Any, Any], Any, None]:
        """
