...
class AORecipeKwargs(KwargsHandler):
    ...
    pad_inner_dim: Optional[bool] = ...
    enable_fsdp_float8_all_gather: Optional[bool] = ...
    def __post_init__(self): # -> None:
        ...
...
class DeepSpeedSequenceParallelConfig:
    sp_seq_length: Optional[int] = ...
    sp_seq_length_is_variable: Optional[bool] = ...
    sp_attn_implementation: Optional[str] = ...
    def __post_init__(self): # -> None:
        ...
...
def parse_glm4_moe_config(megatron_lm_plugin, model, batch_data): # -> None:
    ...
