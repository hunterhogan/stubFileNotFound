...
class BertTrainStep(AbstractTrainStep):
    ...
    def get_batch_func(self, accelerator, megatron_dataset_flag): # -> Callable[..., tuple[Any, Any, Any, Any, Any, Any]] | Callable[..., tuple[Any, Any | None, Any | None, Any | None, Any | None, Any]]:
        ...
...
class GPTTrainStep(AbstractTrainStep):
    ...
    def get_batch_func(self, accelerator, megatron_dataset_flag): # -> Callable[..., tuple[Any, Any, Any, Any, Any]] | Callable[..., tuple[Tensor, Tensor, Any, Any, Any]]:
        ...
...
class T5TrainStep(AbstractTrainStep):
    ...
    def get_batch_func(self, accelerator, megatron_dataset_flag): # -> Callable[..., tuple[Any, Any, Any, Any, Any, Any, Any]] | Callable[..., tuple[Any, Any, Any, Any, Any, Tensor, Any]]:
        ...
