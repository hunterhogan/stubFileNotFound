...
from typing import Any, BinaryIO, ClassVar, IO, Literal, Never, overload, Self
...
class PurePath(PathLike[str]):
    __slots__ = ('_drv', '_hash', '_parts_normcase_cached', '_raw_paths', '_root', '_str', '_str_normcase_cached', '_tail_cached')
    if sys.version_info >= (3, 13):
