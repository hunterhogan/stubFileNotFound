...
from typing import Any, ClassVar, NoReturn, overload, Self, TypeVar
...
class Random(_random.Random):
    ...
    if sys.version_info < (3, 10):
        ...
        def __new__(cls, x: int | float | str | bytes | bytearray | None = None) -> Self: ...

    def seed(self, a: int | float | str | bytes | bytearray | None = None, version: int = 2) -> None: ...  # type: ignore[override]
