...
from typing import (
	Any, ClassVar, Generic, Literal, NoReturn, overload, Protocol, Self, type_check_only, TypeAlias, TypeVar)
...
class Attr(Node):
    __slots__ = ("_localName", "_name", "_prefix", "_value", "childNodes", "namespaceURI", "ownerDocument", "ownerElement")
