...
from typing import (
	Any, ClassVar, Final, Generic, Literal, NamedTuple, overload, Protocol, type_check_only, TypeAlias, TypedDict, TypeVar)
...
class Listbox(Widget, XView, YView):
    def __init__(
        ...
        *,
        ...
        selectmode: str | Literal["single", "browse", "multiple", "extended"] = "browse",
        setgrid: bool = False,
        state: Literal["normal", "disabled"] = "normal",
        takefocus: bool | Literal[0, 1, ""] | Callable[[str], bool | None] = "",
        width: int = 20,
    ...
    def configure(
        ...
        *,
        ...
        selectborderwidth: float | str = ...,
        selectforeground: str = ...,
        selectmode: str | Literal["single", "browse", "multiple", "extended"] = ...,
        setgrid: bool = ...,
        state: Literal["normal", "disabled"] = ...,
        takefocus: bool | Literal[0, 1, ""] | Callable[[str], bool | None] = ...,
        width: int = ...,
