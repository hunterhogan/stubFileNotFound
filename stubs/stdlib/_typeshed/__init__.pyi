...
from typing import (
	Any, AnyStr, ClassVar, Final, final, Generic, Literal, LiteralString, overload, Protocol, Self as _Self, SupportsFloat,
	SupportsIndex, SupportsInt, TypeAlias, TypeVar)
