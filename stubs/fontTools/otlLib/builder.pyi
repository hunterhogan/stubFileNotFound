...
log = ...
def buildCoverage(glyphs, glyphMap): # -> Coverage:
...
def buildLookup(subtables, flags=..., markFilterSet=..., table=..., extension=...): # -> None:
...
class LookupBuilder:
    SUBTABLE_BREAK_ = ...
    def __init__(self, font, location, table, lookup_type, extension=...) -> None:
        ...
    
    def equals(self, other): # -> bool:
        ...
    
    def promote_lookup_type(self, is_named_lookup): # -> list[Self]:
        ...
    
    def inferGlyphClasses(self): # -> dict[Any, Any]:
        """Infers glyph glasses for the GDEF table, such as {"cedilla":3}."""
        ...
    
    def getAlternateGlyphs(self): # -> dict[Any, Any]:
    ...
    def buildMarkClasses_(self, marks): # -> dict[Any, Any]:
    ...
    def build_subst_subtables(self, mapping, klass): # -> list[Any]:
        ...
...
class AlternateSubstBuilder(LookupBuilder):
    ...
    def getAlternateGlyphs(self): # -> OrderedDict[Any, Any]:
        ...
...
class ChainContextualRuleset:
    ...
    def format2ClassDefs(self): # -> list[Any] | None:
        ...
...
class ChainContextSubstBuilder(ChainContextualBuilder):
    ...
    def find_chainable_subst(self, mapping, builder_class): # -> None:
        """Helper for add_{single,multi}_subst_chained_()"""
        ...
    
    def find_chainable_ligature_subst(self, glyphs, replacement): # -> LigatureSubstBuilder | None:
...
class LigatureSubstBuilder(LookupBuilder):
    ...
    def getAlternateGlyphs(self): # -> dict[Any, list[Any]]:
        ...
...
class MarkBasePosBuilder(LookupBuilder):
    ...
    def get_subtables_(self): # -> list[Any]:
        ...
...
class AnySubstBuilder(LookupBuilder):
    ...
    def promote_lookup_type(self, is_named_lookup): # -> list[SingleSubstBuilder] | list[MultipleSubstBuilder] | list[LigatureSubstBuilder] | None:
        ...
...
def buildMarkBasePos(marks, bases, glyphMap): # -> list[Any]:
...
def buildMarkLigPos(marks, ligs, glyphMap): # -> list[Any]:
...
def buildPairPosGlyphs(pairs, glyphMap): # -> list[Any]:
...
def buildSinglePos(mapping, glyphMap): # -> list[Any]:
...
def buildStatTable(ttFont: TTFont, axes, locations=..., elidedFallbackName: Union[STATName, STATNameStatement] = ..., windowsNames: bool = ..., macNames: bool = ...) -> None:
...
def buildMathTable(ttFont, constants=..., italicsCorrections=..., topAccentAttachments=..., extendedShapes=..., mathKerns=..., minConnectorOverlap=..., vertGlyphVariants=..., horizGlyphVariants=..., vertGlyphAssembly=..., horizGlyphAssembly=...): # -> None:
    """
