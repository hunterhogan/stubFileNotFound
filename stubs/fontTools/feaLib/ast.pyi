...
class GlyphClass(Expression):
    ...
    original: Incomplete
    curr: int
    def __init__(self, glyphs=None, location=None) -> None: ...
    def glyphSet(self):
        """The glyphs in this class as a tuple of :class:`GlyphName` objects."""
    def asFea(self, indent: str = ''): ...
...
class LanguageStatement(Statement):
    ...
    required: Incomplete
    def __init__(self, language, include_default: bool = True, required: bool = False, location=None) -> None: ...
    def build(self, builder) -> None:
...
class LookupFlagStatement(Statement):
    ...
    def __init__(self, value: int = 0, markAttachment=None, markFilteringSet=None, location=None) -> None: ...
    def build(self, builder) -> None:
...
class SingleSubstStatement(Statement):
    ...
    glyphs: Incomplete
    replacements: Incomplete
    def __init__(self, glyphs, replace, prefix, suffix, forceChain, location=None) -> None: ...
    def build(self, builder) -> None:
...
class NameRecord(Statement):
    ...
    langID: Incomplete
    string: Incomplete
    def __init__(self, nameID, platformID, platEncID, langID, string, location=None) -> None: ...
    def build(self, builder) -> None:
...
class SizeParameters(Statement):
    ...
    RangeEnd: Incomplete
    def __init__(self, DesignSize, SubfamilyID, RangeStart, RangeEnd, location=None) -> None: ...
    def build(self, builder) -> None:
...
class BaseAxis(Statement):
    ...
    vertical: Incomplete
    minmax: Incomplete
    def __init__(self, bases, scripts, vertical, minmax=None, location=None) -> None: ...
    def build(self, builder) -> None:
...
class STATDesignAxisStatement(Statement):
    ...
    names: Incomplete
    location: Incomplete
    def __init__(self, tag, axisOrder, names, location=None) -> None: ...
    def build(self, builder) -> None: ...
    def asFea(self, indent: str = ''): ...
...
class STATAxisValueStatement(Statement):
    ...
    flags: Incomplete
    def __init__(self, names, locations, flags, location=None) -> None: ...
    def build(self, builder) -> None: ...
    def asFea(self, indent: str = ''): ...
