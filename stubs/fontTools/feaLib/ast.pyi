...
class GlyphName(Expression):
    ...
    def glyphSet(self): # -> tuple[Any]:
        """The glyphs in this class as a tuple of :class:`GlyphName` objects."""
        ...
    
    def asFea(self, indent=...): # -> tuple[Any, ...]:
        ...
...
class BaseAxis(Statement):
    ...
    def __init__(self, bases, scripts, vertical, minmax=..., location=...) -> None:
        ...
