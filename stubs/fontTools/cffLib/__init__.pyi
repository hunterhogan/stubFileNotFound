...
class CFFFontSet:
    r"""A CFF font "file" can contain more than one font, although this is
    ...
    def decompile(self, file: PathLike, otFont, isCFF2=None) -> None:
        ...
        ``file`` should be a file handle object.

        ``otFont`` is the top-level :py:class:`fontTools.ttLib.ttFont.TTFont` object containing this CFF file.

        If ``isCFF2`` is passed and set to ``True`` or ``False``, then the library makes an assertion that the CFF header is of
...
class CFFWriter:
    ...
    topDictSize: Incomplete
    offSize: Incomplete
    def toFile(self, file: PathLike) -> None: ...
...
class Index:
    ...
    def produceItem(self, index, data, file: PathLike, offset): ...
...
class CharStrings:
    r"""The ``CharStrings`` in the font represent the instructions for drawing
    ...
    fdSelect: Incomplete
    fdArray: Incomplete
    def __init__(self, file: PathLike, charset, globalSubrs, private, fdSelect, fdArray, isCFF2=None, varStore=None) -> None: ...
    def keys(self): ...
    def values(self): ...
...
def readCard8(file: PathLike): ...
def readCard16(file: PathLike): ...
def readCard32(file: PathLike): ...
def writeCard8(file: PathLike, value) -> None: ...
def writeCard16(file: PathLike, value) -> None: ...
def writeCard32(file: PathLike, value) -> None: ...
def packCard8(value): ...
...
def parseCharset0(numGlyphs, file: PathLike, strings, isCID): ...
def parseCharset(numGlyphs, file: PathLike, strings, isCID, fmt): ...
...
def readSID(file: PathLike):
    """Read a String ID (SID) — 2-byte unsigned integer."""
def parseEncodingSupplement(file: PathLike, encoding, strings) -> None:
    """
...
class TopDict(BaseDict):
    r"""The ``TopDict`` represents the top-level dictionary holding font
