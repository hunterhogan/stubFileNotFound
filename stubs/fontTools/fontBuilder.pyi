...
class FontBuilder:
    font: Incomplete
    isTTF: Incomplete
    def __init__(self, unitsPerEm=None, font=None, isTTF: bool = True, glyphDataFormat: int = 0) -> None:
    ...
    def _updateTableWithValues(self, tableTag, values) -> None: ...
    ...
    def setupCharacterMap(self, cmapping, uvs=None, allowFallback: bool = False) -> None:
    ...
    def setupCFF2(self, charStringsDict, fdArrayList=None, regions=None) -> None: ...
    ...
    def setupFvar(self, axes, instances) -> None:
        ...
        to strings, to allow localized name table entries.
        """
    def setupAvar(self, axes, mappings=None) -> None:
    ...
    def addFeatureVariations(self, conditionalSubstitutions, featureTag: str = 'rvrn') -> None:
        ...
        """
    def setupCOLR(self, colorLayers, version=None, varStore=None, varIndexMap=None, clipBoxes=None, allowLayerReuse: bool = True) -> None:
        """Build new COLR table using color layers dictionary.

        Cf. `fontTools.colorLib.builder.buildCOLR`.
        """
    def setupCPAL(self, palettes, paletteTypes=None, paletteLabels=None, paletteEntryLabels=None) -> None:
        ...
        """
    def setupStat(self, axes, locations=None, elidedFallbackName: int = 2) -> None:
