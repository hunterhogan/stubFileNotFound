...
class Cu2QuPen(FilterPen):
    ...
    def __init__(self, other_pen: AbstractPen, max_err: float, reverse_direction: bool = False, stats: dict[Incomplete, Incomplete] | None = None, all_quadratic: bool = True) -> None: ...
...
class Cu2QuPointPen(BasePointToSegmentPen):
    ...
    stats: Incomplete
    all_quadratic: Incomplete
    def __init__(self, other_point_pen, max_err, reverse_direction: bool = False, stats=None, all_quadratic: bool = True) -> None: ...
    def _flushContour(self, segments) -> None: ...
    def _split_super_bezier_segments(self, points): ...
    def _drawPoints(self, segments) -> None: ...
...
class Cu2QuMultiPen:
    ...
    def _curves_to_quadratic(self, pointsList) -> None: ...
