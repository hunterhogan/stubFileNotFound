...
from fontTools.pens.pointPen import AbstractPointPen, DecomposingPointPen, ReverseFlipped
...
class _DecomposingFilterPenMixin(_DecomposingFilterMixinBase):
    ...
    def __init__(self, outPen, glyphSet, skipMissingComponents=..., reverseFlipped: bool = ..., include: set[str] | None = ..., decomposeNested: bool = ..., **kwargs) -> None:
        ...
...
class _DecomposingFilterPointPenMixin(_DecomposingFilterMixinBase):
    ...
    """
    skipMissingComponents = ...
    def __init__(self, outPen, glyphSet, skipMissingComponents=..., reverseFlipped: bool | ReverseFlipped = ..., include: set[str] | None = ..., decomposeNested: bool = ..., **kwargs) -> None:
        ...
