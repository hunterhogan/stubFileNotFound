...
import os
from typing import Any, BinaryIO, Literal, Sequence, TYPE_CHECKING, TextIO, TypeVar, TypedDict, overload
...
class TTFont:
    ...
    verbose: bool | None
    quiet: bool | None
    def __init__(self, file: str | os.PathLike[str] | BinaryIO | None = ..., res_name_or_index: str | int | None = ..., sfntVersion: str = ..., flavor: str | None = ..., checkChecksums: int = ..., verbose: bool | None = ..., recalcBBoxes: bool = ..., allowVID: Any = ..., ignoreDecompileErrors: bool = ..., recalcTimestamp: bool = ..., fontNumber: int = ..., lazy: bool | None = ..., quiet: bool | None = ..., _tableCache: MutableMapping[tuple[Tag, bytes], DefaultTable] | None = ..., cfg: Mapping[str, Any] | AbstractConfig = ...) -> None:
        ...
    ...
    def save(self, file: str | os.PathLike[str] | BinaryIO, reorderTables: bool | None = ...) -> None:
    ...
    def saveXML(self, fileOrPath: str | os.PathLike[str] | BinaryIO | TextIO, newlinestr: str = ..., **kwargs: Unpack[XMLSavingOptions]) -> None:
    ...
    def importXML(self, fileOrPath: str | os.PathLike[str] | BinaryIO, quiet: bool | None = ...) -> None:
    ...
    def ensureDecompiled(self, recurse: bool | None = ...) -> None:
    ...
    def get(self, tag: str | bytes, default: Any | None = ...) -> DefaultTable | GlyphOrder | Any | None:
    ...
    def getGlyphSet(self, preferCFF: bool = ..., location: Mapping[str, _NumberT] | None = ..., normalized: bool = ..., recalcBounds: bool = ...) -> _TTGlyphSet:
...
def registerCustomTableClass(tag: str | bytes, moduleName: str, className: str | None = ...) -> None:
...
TTFTableOrder = ...
OTFTableOrder = ...
def sortedTagList(tagList: Sequence[str], tableOrder: Sequence[str] | None = ...) -> list[str]:
...
def reorderFontTables(inFile: BinaryIO, outFile: BinaryIO, tableOrder: Sequence[str] | None = ..., checkChecksums: bool = ...) -> None:
