...
class Silf:
    ...
    oPasses: Incomplete
    classes: Incomplete
    def decompile(self, data, ttFont: TTFont, version: float = 2.0) -> None: ...
    numPasses: Incomplete
    numJLevels: Incomplete
    numCritFeatures: Incomplete
    passOffset: Incomplete
    pseudosOffset: Incomplete
    def compile(self, ttFont: TTFont, version: float = 2.0): ...
    def toXML(self, writer, ttFont: TTFont, version: float = 2.0) -> None: ...
