...
class TupleVariation:
    ...
    def compile(self, axisTags, sharedCoordIndices={}, pointData=None, *, optimizeSize: bool = True): ...
    ...
    def compileDeltas(self, optimizeSize: bool = True): ...
    @staticmethod
    def compileDeltaValues_(deltas, bytearr=None, *, optimizeSize: bool = True):
    ...
    @staticmethod
    def encodeDeltaRunAsBytes_(deltas, offset, bytearr, optimizeSize: bool = True): ...
    @staticmethod
    def encodeDeltaRunAsWords_(deltas, offset, bytearr, optimizeSize: bool = True): ...
    @staticmethod
    def encodeDeltaRunAsLongs_(deltas, offset, bytearr, optimizeSize: bool = True): ...
    @staticmethod
...
def compileTupleVariationStore(variations, pointCount, axisTags, sharedTupleIndices, useSharedPoints: bool = True, *, optimizeSize: bool = True): ...
