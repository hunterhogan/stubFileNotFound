...
def _reverseBytes(data):
    ...
    b'\\x00\\x0f'
    """
def _writeRawImageData(strikeIndex, glyphName, bitmapObject, writer, ttFont: TTFont) -> None: ...
def _readRawImageData(bitmapObject, name, attrs, content, ttFont: TTFont) -> None: ...
def _writeRowImageData(strikeIndex, glyphName, bitmapObject, writer, ttFont: TTFont) -> None: ...
def _readRowImageData(bitmapObject, name, attrs, content, ttFont: TTFont) -> None: ...
def _writeBitwiseImageData(strikeIndex, glyphName, bitmapObject, writer, ttFont: TTFont) -> None: ...
def _readBitwiseImageData(bitmapObject, name, attrs, content, ttFont: TTFont) -> None: ...
def _writeExtFileImageData(strikeIndex, glyphName, bitmapObject, writer, ttFont: TTFont) -> None: ...
def _readExtFileImageData(bitmapObject, name, attrs, content, ttFont: TTFont) -> None: ...
