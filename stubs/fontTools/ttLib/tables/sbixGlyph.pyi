...
class Glyph:
    ...
    def __init__(self, glyphName=None, referenceGlyphName=None, originOffsetX: int = 0, originOffsetY: int = 0, graphicType=None, imageData=None, rawdata=None, gid: int = 0) -> None: ...
