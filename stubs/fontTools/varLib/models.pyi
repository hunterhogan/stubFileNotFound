...
def subList(truth, lst): # -> list[Any]:
    ...

def normalizeValue(v: float, triple: Sequence[float], extrapolate: bool = ...) -> float:
...
def normalizeLocation(location: Mapping[str, float], axes: Mapping[str, tuple[float, float, float]], extrapolate: bool = ..., *, validate: bool = ...) -> dict[str, float]:
...
class VariationModel:
    ...
    """
    def __init__(self, locations, axisOrder=..., extrapolate=..., *, axisRanges=...) -> None:
        ...
    
    def getSubModel(self, items): # -> tuple[Self, Any] | tuple[VariationModel | Any, list[Any]]:
    ...
    @staticmethod
    def computeAxisRanges(locations): # -> dict[Any, Any]:
        ...
    
    @staticmethod
    def getMasterLocationsSortKeyFunc(locations, axisOrder=...): # -> Callable[..., tuple[int, int, tuple[Any | int, ...], tuple[Any, ...], tuple[int, ...], tuple[Any, ...]]]:
        ...
    
    def reorderMasters(self, master_list, mapping): # -> list[Any]:
        ...
    
    def getDeltas(self, masterValues, *, round=...): # -> list[Any]:
        ...
    
    def getDeltasAndSupports(self, items, *, round=...): # -> tuple[list[Any] | Any, Any | list[Any]]:
        ...
    
    def getScalars(self, loc): # -> list[float | Any]:
    ...
    def getMasterScalars(self, targetLocation): # -> list[float | Any]:
    ...
    @staticmethod
    def interpolateFromValuesAndScalars(values, scalars): # -> None:
