...
class VariationModel:
    ...
    _subModels: Incomplete
    def __init__(self, locations, axisOrder=None, extrapolate: bool = False, *, axisRanges=None) -> None: ...
    ...
    supports: Incomplete
    def _computeMasterSupports(self) -> None: ...
    def _locationsToRegions(self): ...
    deltaWeights: Incomplete
    def _computeDeltaWeights(self) -> None: ...
