...
class InterpolatablePlot:
    ...
    def __init__(self, out, glyphsets, names=None, **kwargs) -> None: ...
    def __enter__(self): ...
    ...
    def draw_label(self, label, *, x: int = 0, y: int = 0, color=(0, 0, 0), align: int = 0, bold: bool = False, width=None, height=None, font_size=None) -> None: ...
    def draw_glyph(self, glyphset, glyphname, problems, which, *, x: int = 0, y: int = 0, scale=None): ...
    ...
    def draw_text(self, text, *, x: int = 0, y: int = 0, color=(0, 0, 0), width=None, height=None) -> None: ...
