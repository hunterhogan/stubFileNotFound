...
class Subsetter:
    ...
    def populate(self, glyphs: list[str] = [], gids: list[int] = [], unicodes: list[int] = [], text: str = '') -> None: ...
...
def load_font(fontFile: PathLike, options, checkChecksums: int = 0, dontLoadGlyphNames: bool = False, lazy: bool = True): ...
def save_font(font, outfile: PathLike, options) -> None: ...
def parse_unicodes(s: str) -> list[int]: ...
def parse_gids(s: str) -> list[int]: ...
def parse_glyphs(s: str) -> list[str]: ...
def main(args=None):
