...
class DesignSpaceDocumentError(Exception):
    msg: Incomplete
    obj: Incomplete
    def __init__(self, msg, obj=None) -> None: ...
...
class InstanceDescriptor(SimpleDescriptor):
    ...
    designLocation: AnisotropicLocationDict
...
class AxisDescriptor(AbstractAxisDescriptor):
    ...
    maximum: Incomplete
    default: Incomplete
    def __init__(self, *, tag=None, name=None, labelNames=None, minimum=None, default=None, maximum=None, hidden: bool = False, map=None, axisOrdering=None, axisLabels=None) -> None: ...
    def serialize(self): ...
...
class DiscreteAxisDescriptor(AbstractAxisDescriptor):
    ...
    default: float
    values: list[float]
    def __init__(self, *, tag=None, name=None, labelNames=None, values=None, default=None, hidden: bool = False, map=None, axisOrdering=None, axisLabels=None) -> None: ...
...
class AxisLabelDescriptor(SimpleDescriptor):
    ...
    def __init__(self, *, name, userValue, userMinimum=None, userMaximum=None, elidable: bool = False, olderSibling: bool = False, linkedUserValue=None, labelNames=None) -> None: ...
...
class LocationLabelDescriptor(SimpleDescriptor):
    ...
    def __init__(self, *, name, userLocation, elidable: bool = False, olderSibling: bool = False, labelNames=None) -> None: ...
    @property
    def defaultName(self) -> str:
        """Return the English name from :attr:`labelNames` or the :attr:`name`."""
    def getFullUserLocation(self, doc: DesignSpaceDocument) -> SimpleLocationDict:
...
class VariableFontDescriptor(SimpleDescriptor):
    ...
    def __init__(self, *, name, filename=None, axisSubsets=None, lib=None) -> None: ...
...
class RangeAxisSubsetDescriptor(SimpleDescriptor):
    ...
    userMaximum: float
    def __init__(self, *, name, userMinimum=..., userDefault=None, userMaximum=...) -> None: ...
...
class BaseDocWriter:
    ...
    def _addRule(self, ruleObject) -> None: ...
    def _addAxis(self, axisObject) -> None: ...
    def _addAxisMapping(self, mappingsElement, mappingObject) -> None: ...
    def _addAxisLabel(self, axisElement: ET.Element, label: AxisLabelDescriptor) -> None: ...
    def _addLabelNames(self, parentElement, labelNames) -> None: ...
    ...
    def _addInstance(self, instanceObject) -> None: ...
    def _addSource(self, sourceObject) -> None: ...
...
class BaseDocReader(LogMixin):
    ...
    def _readSingleInstanceElement(self, instanceElement, makeGlyphs: bool = True, makeKerning: bool = True, makeInfo: bool = True) -> None: ...
