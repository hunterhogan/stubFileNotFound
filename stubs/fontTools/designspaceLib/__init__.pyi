...
class SourceDescriptor(SimpleDescriptor):
    ...
    @property
    def location(self): # -> SimpleLocationDict:
    ...
    @location.setter
    def location(self, location: Optional[SimpleLocationDict]): # -> None:
        ...
    ...
    def getFamilyName(self, languageCode=...): # -> None:
...
def processRules(rules, location, glyphNames): # -> list[Any]:
...
class AxisMappingDescriptor(SimpleDescriptor):
    ...
    """
    _attrs = ...
    def __init__(self, *, inputLocation=..., outputLocation=..., description=..., groupDescription=...) -> None:
        ...
...
class InstanceDescriptor(SimpleDescriptor):
    ...
    def getStyleName(self, languageCode=...): # -> None:
        ...
    ...
    def getStyleMapStyleName(self, languageCode=...): # -> None:
        ...
    
    def setStyleMapFamilyName(self, styleMapFamilyName, languageCode=...): # -> None:
        ...
    
    def getStyleMapFamilyName(self, languageCode=...): # -> None:
        ...
...
def tagForAxisName(name): # -> tuple[str, dict[str, str]] | tuple[Any, dict[str, Any]]:
    ...
...
class BaseDocReader(LogMixin):
    ...
    @classmethod
    def fromstring(cls, string, documentObject): # -> Self:
        ...
    ...
    def locationFromElement(self, element): # -> tuple[dict[Any, Any], dict[Any, Any]] | tuple[None, None]:
    ...
    def readLocationElement(self, locationElement): # -> tuple[dict[Any, Any], dict[Any, Any]]:
...
class DesignSpaceDocument(LogMixin, AsDictMixin):
    ...
    **Note:** Python attribute names are usually camelCased, the
    ...
    @classmethod
    def fromfile(cls, path, readerClass=..., writerClass=...): # -> Self:
    ...
    @classmethod
    def fromstring(cls, string, readerClass=..., writerClass=...): # -> Self:
        ...
    
    def tostring(self, encoding=...): # -> bytes | str:
    ...
    def newDefaultLocation(self): # -> OrderedDict[Any, Any]:
    ...
    def getAxisOrder(self): # -> list[Any]:
    ...
    def normalizeLocation(self, location): # -> dict[Any, Any]:
    ...
    def loadSourceFonts(self, opener, **kwargs): # -> list[Any]:
    ...
    def deepcopyExceptFonts(self): # -> Self:
