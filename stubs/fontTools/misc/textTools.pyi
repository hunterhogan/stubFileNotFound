...
def hexStr(data): # -> LiteralString | Literal['']:
...
def caselessSort(alist): # -> list[Any]:
...
def tostr(s: str | bytes, encoding: str = ..., errors: str = ...) -> str:
    ...

def tobytes(s: str | bytes, encoding: str = ..., errors: str = ...) -> bytes:
    ...
