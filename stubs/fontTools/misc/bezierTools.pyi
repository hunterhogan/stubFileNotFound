...
def calcQuadraticBounds(pt1, pt2, pt3): # -> tuple[Literal[0], Literal[0], Literal[0], Literal[0]] | tuple[Any, Any, Any, Any]:
...
def calcCubicBounds(pt1, pt2, pt3, pt4): # -> tuple[Literal[0], Literal[0], Literal[0], Literal[0]] | tuple[Any, Any, Any, Any]:
    """Calculates the bounding rectangle for a quadratic Bezier segment.
...
def splitLine(pt1, pt2, where, isHorizontal): # -> list[tuple[Any, Any]] | list[tuple[Any, tuple[Any, Any]] | tuple[tuple[Any, Any], Any]]:
...
def splitQuadratic(pt1, pt2, pt3, where, isHorizontal): # -> list[tuple[Any, Any, Any]] | list[Any]:
...
def splitCubic(pt1, pt2, pt3, pt4, where, isHorizontal): # -> list[tuple[Any, Any, Any, Any]] | list[Any]:
...
def splitQuadraticAtT(pt1, pt2, pt3, *ts): # -> list[Any]:
...
def splitCubicAtT(pt1, pt2, pt3, pt4, *ts): # -> list[Any]:
...
def splitCubicAtTC(pt1, pt2, pt3, pt4, *ts): # -> Generator[tuple[Any, Any, Any, Any], Any, None]:
    """Split a cubic Bezier curve at one or more values of t.
...
def splitCubicIntoTwoAtTC(pt1, pt2, pt3, pt4, t): # -> tuple[tuple[Any, Any, Any, Any], tuple[Any, Any, Any, Any]]:
...
def solveQuadratic(a, b, c, sqrt=...): # -> list[Any]:
...
def solveCubic(a, b, c, d): # -> list[Any]:
...
def calcQuadraticParameters(pt1, pt2, pt3): # -> tuple[tuple[Any, Any], tuple[Any, Any], tuple[Any, Any]]:
    ...

def calcCubicParameters(pt1, pt2, pt3, pt4): # -> tuple[tuple[Any, Any], tuple[Any, Any], tuple[Any, Any], tuple[Any, Any]]:
    ...
...
def calcCubicParametersC(pt1, pt2, pt3, pt4): # -> tuple[Any, Any, Any, Any]:
    ...

def calcQuadraticPoints(a, b, c): # -> tuple[tuple[Any, Any], tuple[Any, Any], tuple[Any, Any]]:
    ...

def calcCubicPoints(a, b, c, d): # -> tuple[tuple[Any, Any], tuple[Any, Any], tuple[Any, Any], tuple[Any, Any]]:
    ...

@cython.cfunc
@cython.inline
@cython.locals(a=cython.complex, b=cython.complex, c=cython.complex, d=cython.complex, p2=cython.complex, p3=cython.complex, p4=cython.complex)
def calcCubicPointsC(a, b, c, d): # -> tuple[Any, Any, Any, Any]:
    ...

def linePointAtT(pt1, pt2, t): # -> tuple[Any, Any]:
...
def quadraticPointAtT(pt1, pt2, pt3, t): # -> tuple[Any, Any]:
...
def cubicPointAtT(pt1, pt2, pt3, pt4, t): # -> tuple[Any, Any]:
...
def lineLineIntersections(s1, e1, s2, e2): # -> list[Any] | list[Intersection]:
...
def curveLineIntersections(curve, line): # -> list[Any]:
...
def curveCurveIntersections(curve1, curve2): # -> list[Any] | list[Intersection]:
...
def segmentSegmentIntersections(seg1, seg2): # -> list[Any] | list[Intersection]:
