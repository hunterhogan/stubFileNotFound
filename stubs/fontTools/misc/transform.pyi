...
class Transform(NamedTuple):
    ...
    dx: float = ...
    dy: float = ...
    def transformPoint(self, p): # -> tuple[Any, Any]:
        """Transform a point.
    ...
    def transformPoints(self, points): # -> list[tuple[Any, Any]]:
    ...
    def transformVector(self, v): # -> tuple[Any, Any]:
    ...
    def transformVectors(self, vectors): # -> list[tuple[Any, Any]]:
    ...
    def scale(self, x: float = ..., y: float | None = ...): # -> Self:
    ...
    def skew(self, x: float = ..., y: float = ...): # -> Self:
...
Identity = ...
def Offset(x: float = ..., y: float = ...) -> Transform:
...
def Scale(x: float, y: float | None = ...) -> Transform:
