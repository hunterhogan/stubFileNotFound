...
CharStringProgramToken: TypeAlias = int | float | str | bytes
CharStringProgram: TypeAlias = list[CharStringProgramToken]
...
t1OperandEncoding: list
t2OperandEncoding: list
cffDictOperandEncoding: list
realNibbles: list
realNibblesDict: dict
maxOpStack: int
def buildOperatorDict(operatorList): ...

t2Operators: list
def getIntEncoder(format): ...
def encodeIntCFF(value, fourByteOp: bytes = ..., bytechr: Callable = ..., pack = ..., unpack = ..., twoByteOp: bytes = ...): ...
def encodeIntT1(value, fourByteOp: bytes = ..., bytechr: Callable = ..., pack = ..., unpack = ..., twoByteOp: Incomplete | None = ...): ...
def encodeIntT2(value, fourByteOp: Incomplete | None = ..., bytechr: Callable = ..., pack = ..., unpack = ..., twoByteOp: bytes = ...): ...
...
class T2CharString:
    class decompilerClass:
        def __init__(self, localSubrs, globalSubrs, private: Incomplete | None = ..., blender: Incomplete | None = ...) -> None: ...
        def reset(self): ...
        def execute(self, charString, *, pushToStack: Incomplete | None = ...): ...
        def pop(self): ...
        def popall(self): ...
        def push(self, value): ...
    ...
    class outlineExtractor(T2WidthExtractor):
        def __init__(self, pen, localSubrs, globalSubrs, nominalWidthX, defaultWidthX, private: Incomplete | None = ..., blender: Incomplete | None = ...) -> None: ...
        def reset(self): ...
        def execute(self, charString): ...
        def _nextPoint(self, point): ...
        ...
        def hcurveto(self, args): ...
    bytecode: bytes | None
    program: CharStringProgram | None
    private: Incomplete | None
    globalSubrs: list[T2CharString]
    _cur_vsindex: int | None

    operandEncoding: ClassVar[list] = t2OperandEncoding
    operators: ClassVar[dict] = ...
    opcodes: ClassVar[dict] = ...
    def __init__( self , bytecode: bytes | None = ... , program: CharStringProgram | None = ... , private: Incomplete | None = ... , globalSubrs: list[T2CharString] | None = ... ) -> None: ...
    def getNumRegions(self, vsindex: int | None = ...) -> int: ...
    def __repr__(self) -> str: ...
    def getIntEncoder(self) -> Callable[[int], bytes]: ...
    def getFixedEncoder(self) -> Callable[[float], bytes]: ...
    ...
    def setProgram(self, program: CharStringProgram) -> None: ...
    def setBytecode(self, bytecode: bytes) -> None: ...
    def getToken(self, index: int, len=..., byteord=..., isinstance=...) -> tuple[CharStringProgramToken | None, bool, int]: ...
    def getBytes(self, index: int, nBytes: int) -> tuple[bytes, int]: ...
    def handle_operator(self, operator: str) -> str: ...
    def toXML(self, xmlWriter, ttFont=None) -> None: ...
    def fromXML(self, name, attrs, content) -> None: ...

class T1CharString(T2CharString):
    operandEncoding: ClassVar[list] = t1OperandEncoding
    operators: ClassVar[dict] = ...
    opcodes: ClassVar[dict] = ...
    subrs: list[T1CharString] | None
    def __init__( self , bytecode: bytes | None = ... , program: CharStringProgram | None = ... , subrs: list[T1CharString] | None = ... ) -> None: ...
    def getIntEncoder(self) -> Callable[[int], bytes]: ...
