...
so on.
"""
def calcBounds(array): # -> tuple[Literal[0], Literal[0], Literal[0], Literal[0]] | tuple[Any, Any, Any, Any]:
...
def calcIntBounds(array, round=...): # -> tuple[Any, ...]:
...
def updateBounds(bounds, p, min=..., max=...): # -> tuple[Any, Any, Any, Any]:
...
def pointsInRect(array, rect): # -> list[Any]:
...
def normRect(rect): # -> tuple[Any, Any, Any, Any]:
...
def scaleRect(rect, x, y): # -> tuple[Any, Any, Any, Any]:
...
def offsetRect(rect, dx, dy): # -> tuple[Any, Any, Any, Any]:
...
def insetRect(rect, dx, dy): # -> tuple[Any, Any, Any, Any]:
...
def sectRect(rect1, rect2): # -> tuple[Literal[False], tuple[int, int, int, int]] | tuple[Literal[True], tuple[Any, Any, Any, Any]]:
...
def unionRect(rect1, rect2): # -> tuple[Any, Any, Any, Any]:
...
def rectCenter(rect): # -> tuple[Any, Any]:
...
def quantizeRect(rect, factor=...): # -> tuple[int, int, int, int]:
    """
...
def pairwise(iterable, reverse=...): # -> Generator[tuple[Any | None, Any] | tuple[Any | None, Any | None], Any, None]:
