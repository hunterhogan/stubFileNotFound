...
class Timer:
    ...
    def __call__(self, func_or_msg=..., **kwargs): # -> _Wrapped[Callable[..., Any], Any, Callable[..., Any], Any] | Self:
...
class CapturingLogHandler(logging.Handler):
    ...
    def __exit__(self, type, value, traceback): # -> Self:
        ...
...
def deprecateFunction(msg, category=...): # -> Callable[..., _Wrapped[Callable[..., Any], Any, Callable[..., Any], Any]]:
