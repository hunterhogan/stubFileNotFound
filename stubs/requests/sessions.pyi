...
class SessionRedirectMixin:
    ...
    def resolve_redirects(self, resp, req, stream: bool = False, timeout: Incomplete | None = None, verify: bool = True, cert: Incomplete | None = None, proxies: Incomplete | None = None, yield_requests: bool = False, **adapter_kwargs) -> Generator[Incomplete]:
