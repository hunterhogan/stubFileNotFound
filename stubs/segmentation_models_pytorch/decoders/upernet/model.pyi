from .decoder import UPerNetDecoder as UPerNetDecoder
...
class UPerNet(SegmentationModel):
    ...
    def __init__(self, encoder_name: str = 'resnet34', encoder_depth: int = 5, encoder_weights: str | None = 'imagenet', decoder_channels: int = 256, decoder_use_norm: bool | str | dict[str, Any] = 'batchnorm', in_channels: int = 3, classes: int = 1, activation: str | Callable | None = None, upsampling: int = 4, aux_params: dict | None = None, **kwargs: dict[str, Any]) -> None: ...
