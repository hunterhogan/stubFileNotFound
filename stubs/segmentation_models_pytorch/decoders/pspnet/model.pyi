...
class PSPNet(SegmentationModel):
    ...
    *encoder* and *Spatial Pyramid* (decoder). Spatial Pyramid build on top of encoder and does not
    ...
    def __init__(self, encoder_name: str = 'resnet34', encoder_weights: str | None = 'imagenet', encoder_depth: int = 3, psp_out_channels: int = 512, decoder_use_norm: bool | str | dict[str, Any] = 'batchnorm', psp_dropout: float = 0.2, in_channels: int = 3, classes: int = 1, activation: str | Callable | None = None, upsampling: int = 8, aux_params: dict | None = None, **kwargs: dict[str, Any]) -> None: ...
