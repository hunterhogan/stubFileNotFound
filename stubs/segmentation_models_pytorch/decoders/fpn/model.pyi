...
class FPN(SegmentationModel):
    ...
    def __init__(self, encoder_name: str = 'resnet34', encoder_depth: int = 5, encoder_weights: str | None = 'imagenet', decoder_pyramid_channels: int = 256, decoder_segmentation_channels: int = 128, decoder_merge_policy: str = 'add', decoder_dropout: float = 0.2, decoder_interpolation: str = 'nearest', in_channels: int = 3, classes: int = 1, activation: str | None = None, upsampling: int = 4, aux_params: dict | None = None, **kwargs: dict[str, Any]) -> None: ...
