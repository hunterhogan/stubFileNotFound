...
class PAN(SegmentationModel):
    ...
    def __init__(self, encoder_name: str = 'resnet34', encoder_depth: Literal[3, 4, 5] = 5, encoder_weights: str | None = 'imagenet', encoder_output_stride: Literal[16, 32] = 16, decoder_channels: int = 32, decoder_interpolation: str = 'bilinear', in_channels: int = 3, classes: int = 1, activation: str | Callable | None = None, upsampling: int = 4, aux_params: dict | None = None, **kwargs: dict[str, Any]) -> None: ...
