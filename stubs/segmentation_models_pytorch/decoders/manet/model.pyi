...
class MAnet(SegmentationModel):
    ...
    def __init__(self, encoder_name: str = 'resnet34', encoder_depth: int = 5, encoder_weights: str | None = 'imagenet', decoder_use_norm: bool | str | dict[str, Any] = 'batchnorm', decoder_channels: Sequence[int] = (256, 128, 64, 32, 16), decoder_pab_channels: int = 64, decoder_interpolation: str = 'nearest', in_channels: int = 3, classes: int = 1, activation: str | Callable | None = None, aux_params: dict | None = None, **kwargs: dict[str, Any]) -> None: ...
