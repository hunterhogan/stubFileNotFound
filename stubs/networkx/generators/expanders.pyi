...
__all__ = ['margulis_gabber_galil_graph', 'chordal_cycle_graph', 'paley_graph', 'maybe_regular_expander', 'is_regular_expander', 'random_regular_expander_graph']
...
def paley_graph(p, create_using: Incomplete | None = None):
    ...
    """
def maybe_regular_expander(n, d, *, create_using: Incomplete | None = None, max_tries: int = 100, seed: Incomplete | None = None):
    ...
    """
def is_regular_expander(G, *, epsilon: int = 0):
    ...
    """
def random_regular_expander_graph(n, d, *, epsilon: int = 0, create_using: Incomplete | None = None, max_tries: int = 100, seed: Incomplete | None = None):
