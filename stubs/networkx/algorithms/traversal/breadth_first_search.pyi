...
def generic_bfs_edges(G, source, neighbors: Incomplete | None = None, depth_limit: Incomplete | None = None) -> Generator[Incomplete]:
...
def bfs_tree(G, source, reverse: bool = False, depth_limit: Incomplete | None = None, sort_neighbors: Incomplete | None = None):
    ...
    edge_bfs
    '''
def bfs_predecessors(G, source, depth_limit: Incomplete | None = None, sort_neighbors: Incomplete | None = None) -> Generator[Incomplete]:
    ...
    edge_bfs
    '''
def bfs_successors(G, source, depth_limit: Incomplete | None = None, sort_neighbors: Incomplete | None = None) -> Generator[Incomplete]:
    ...
    edge_bfs
    '''
def bfs_layers(G, sources) -> Generator[Incomplete]:
    ...
    {0: [1, 6], 1: [0, 3, 4, 2], 2: [5]}
    """
def bfs_labeled_edges(G, sources) -> Generator[Incomplete]:
