...
def node_attribute_xy(G, attribute, nodes: Incomplete | None = None) -> Generator[Incomplete]:
    ...
    '''
def node_degree_xy(G, x: str = 'out', y: str = 'in', weight: Incomplete | None = None, nodes: Incomplete | None = None) -> Generator[Incomplete]:
