...
def is_directed_acyclic_graph(G):
    ...
    topological_sort
    """
def topological_generations(G) -> Generator[Incomplete]:
    ...
    topological_sort
    """
def topological_sort(G) -> Generator[Incomplete, Incomplete]:
...
def lexicographical_topological_sort(G, key: Incomplete | None = None) -> Generator[Incomplete, None, Incomplete]:
    ...
    .. [1] Manber, U. (1989).
       *Introduction to Algorithms - A Creative Approach.* Addison-Wesley.
    '''
def all_topological_sorts(G) -> Generator[Incomplete]:
...
def transitive_reduction(G):
    ...
    '''
def antichains(G, topo_order: Incomplete | None = None) -> Generator[Incomplete]:
