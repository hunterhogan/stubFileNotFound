...
def fast_label_propagation_communities(G, *, weight: Incomplete | None = None, seed: Incomplete | None = None) -> Generator[Incomplete, Incomplete]:
    ...
    '''
def asyn_lpa_communities(G, weight: Incomplete | None = None, seed: Incomplete | None = None) -> Generator[Incomplete, Incomplete]:
