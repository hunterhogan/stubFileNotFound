...
def louvain_communities(G, weight: str = 'weight', resolution: int = 1, threshold: float = 1e-07, max_level: Incomplete | None = None, seed: Incomplete | None = None):
    ...
    louvain_partitions
    '''
def louvain_partitions(G, weight: str = 'weight', resolution: int = 1, threshold: float = 1e-07, seed: Incomplete | None = None) -> Generator[Incomplete]:
