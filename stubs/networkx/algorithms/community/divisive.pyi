...
def edge_betweenness_partition(G, number_of_sets, *, weight: Incomplete | None = None):
    ...
    """
def edge_current_flow_betweenness_partition(G, number_of_sets, *, weight: Incomplete | None = None):
