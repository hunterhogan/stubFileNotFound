...
def single_target_shortest_path_length(G, target, cutoff: Incomplete | None = None):
    ...
    '''
def all_pairs_shortest_path_length(G, cutoff: Incomplete | None = None) -> Generator[Incomplete]:
...
def single_target_shortest_path(G, target, cutoff: Incomplete | None = None):
    ...
    """
def all_pairs_shortest_path(G, cutoff: Incomplete | None = None) -> Generator[Incomplete]:
