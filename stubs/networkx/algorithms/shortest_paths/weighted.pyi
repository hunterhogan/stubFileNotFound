...
def dijkstra_predecessor_and_distance(G, source, cutoff: Incomplete | None = None, weight: str = 'weight'):
    ...
    [(0, 0), (1, 1)]
    """
def all_pairs_dijkstra(G, cutoff: Incomplete | None = None, weight: str = 'weight') -> Generator[Incomplete]:
    ...
    '''
def all_pairs_dijkstra_path_length(G, cutoff: Incomplete | None = None, weight: str = 'weight') -> Generator[Incomplete]:
    ...
    '''
def all_pairs_dijkstra_path(G, cutoff: Incomplete | None = None, weight: str = 'weight') -> Generator[Incomplete]:
...
def single_source_bellman_ford(G, source, target: Incomplete | None = None, weight: str = 'weight'):
    ...
    '''
def all_pairs_bellman_ford_path_length(G, weight: str = 'weight') -> Generator[Incomplete]:
    '''Compute shortest path lengths between all nodes in a weighted graph.
    ...
    The dictionary returned only has keys for reachable node pairs.
    '''
def all_pairs_bellman_ford_path(G, weight: str = 'weight') -> Generator[Incomplete]:
    '''Compute shortest paths between all nodes in a weighted graph.
