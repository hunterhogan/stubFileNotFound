...
def is_semieulerian(G):
    ...
    is_eulerian
    """
def eulerian_circuit(G, source: Incomplete | None = None, keys: bool = False) -> Generator[Incomplete, Incomplete]:
...
def has_eulerian_path(G, source: Incomplete | None = None):
    ...
    eulerian_path
    """
def eulerian_path(G, source: Incomplete | None = None, keys: bool = False) -> Generator[Incomplete, Incomplete]:
