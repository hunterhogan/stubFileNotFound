...
def is_simple_path(G, nodes):
    ...
    *edge paths*. There is a bijection between node paths and edge
    ...
    """
def all_simple_paths(G, source, target, cutoff: Incomplete | None = None) -> Generator[Incomplete]:
    ...
    '''
def all_simple_edge_paths(G, source, target, cutoff: Incomplete | None = None) -> Generator[Incomplete, Incomplete]:
