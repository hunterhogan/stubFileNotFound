...
def edge_disjoint_paths(G, s, t, flow_func: Incomplete | None = None, cutoff: Incomplete | None = None, auxiliary: Incomplete | None = None, residual: Incomplete | None = None) -> Generator[Incomplete]:
    ...
    '''
def node_disjoint_paths(G, s, t, flow_func: Incomplete | None = None, cutoff: Incomplete | None = None, auxiliary: Incomplete | None = None, residual: Incomplete | None = None) -> Generator[Incomplete]:
