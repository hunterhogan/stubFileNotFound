...
def is_biconnected(G):
    ...
    '''
def biconnected_component_edges(G) -> Generator[Incomplete, Incomplete]:
    ...
    '''
def biconnected_components(G) -> Generator[Incomplete]:
    ...
    '''
def articulation_points(G) -> Generator[Incomplete]:
