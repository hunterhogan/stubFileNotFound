...
class DiGraph(Graph[_Node]):
    ...
    **Subclassing Example**
    ...
    def to_undirected(self, as_view: bool = False) -> Graph[_Node]:
        ...
        Notes
        -----
        This method can also accept a `reciprocal` parameter (bool, default=False). If True, only edges that appear in both
        directions in the original digraph will be kept in the undirected graph.
