...
def get_node_attributes(G, name, default: Incomplete | None = None):
    ...
    \'yellow\'
    '''
def remove_node_attributes(G, *attr_names, nbunch: Incomplete | None = None) -> None:
...
def get_edge_attributes(G, name, default: Incomplete | None = None):
    ...
    \'yellow\'
    '''
def remove_edge_attributes(G, *attr_names, ebunch: Incomplete | None = None) -> None:
...
def non_neighbors(graph, node):
    ...
    """
def non_edges(graph) -> Generator[Incomplete]:
