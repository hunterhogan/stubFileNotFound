...
'''
def profile(statement, globals_, locals_): # -> Profile:
    '''Profile a statement and return the `Profile`.'''
    ...

def profile_expression(expression, globals_, locals_): # -> tuple[Any, Profile]:
    '''Profile an expression, and return a tuple of `(result, profile)`.'''
    ...

def profile_ready(condition=..., off_after=..., profile_handler=...): # -> Callable[..., Any]:
    '''
