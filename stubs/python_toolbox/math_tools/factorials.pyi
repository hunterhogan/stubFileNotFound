...
def factorial(x: Any, start: int = 1) -> Any:
    """
    ...
    """
def inverse_factorial(number: Any, round_up: bool = True) -> Any:
    """
    ...
    """
def from_factoradic(factoradic_number: Any) -> Any:
    """
    ...
    """
def to_factoradic(number: Any, n_digits_pad: int = 0) -> Any:
    """
