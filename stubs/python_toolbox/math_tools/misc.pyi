...
def cute_floor_div(x: Any, y: Any) -> Any:
    """
    ...
    """
def cute_divmod(x: Any, y: Any) -> Any:
    """
    ...
    `infinity`. (Python's built-in `divmod` would make it `nan`.)
    """
def get_sign(x: Any) -> Any:
    """Get the sign of a number."""
def round_to_int(x: Any, up: bool = False) -> Any:
    """
    ...
    `int(round(x))`.
    """
def ceil_div(x: Any, y: Any) -> Any:
    """Divide `x` by `y`, rounding up if there's a remainder."""
def convert_to_base_in_tuple(number: Any, base: Any) -> Any:
    """
...
def binomial(big: Any, small: Any) -> Any:
    ...
    """
def product(numbers: Any) -> Any:
    """Get the product of all the numbers in `numbers`."""
def is_integer(x: Any) -> Any:
    """
    Is `x` an integer?
...
def cute_round(x: Any, round_mode: Any=..., *, step: int = 1) -> Any:
    """
