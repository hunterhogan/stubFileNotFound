...
class SortedSet(MutableSet, Sequence):
    ...
    * :func:`SortedKeyList.irange_key`
    ...
    def difference(self, *iterables): # -> Self:
    ...
    __sub__ = ...
    def difference_update(self, *iterables): # -> Self:
    ...
    __isub__ = ...
    def intersection(self, *iterables): # -> Self:
    ...
    __and__ = ...
    __rand__ = ...
    def intersection_update(self, *iterables): # -> Self:
    ...
    __or__ = ...
    __ror__ = ...
    def update(self, *iterables): # -> Self:
    ...
    __ior__ = ...
    _update = ...
    def __reduce__(self): # -> tuple[type[Self], tuple[set[Any], Any | None]]:
        """Support for pickle.
