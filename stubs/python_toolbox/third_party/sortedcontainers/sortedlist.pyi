...
if hexversion < 50331648:
    ...
    ...
def recursive_repr(fillvalue=...): # -> Callable[..., _Wrapped[Callable[..., Any], Any, Callable[..., Any], str | Any]]:
...
class SortedList(MutableSequence):
    ...
    * :func:`SortedList._reset`
    ...
    def islice(self, start=..., stop=..., reverse=...): # -> Iterator[Never] | chain[Any]:
    ...
    def irange(self, minimum=..., maximum=..., inclusive=..., reverse=...): # -> Iterator[Never] | chain[Any]:
...
class SortedKeyList(SortedList):
    ...
    * :func:`SortedKeyList.irange_key`
    ...
    def __new__(cls, iterable=..., key=...): # -> Self:
        ...
    ...
    def irange_key(self, min_key=..., max_key=..., inclusive=..., reverse=...): # -> Iterator[Never] | chain[Any]:
