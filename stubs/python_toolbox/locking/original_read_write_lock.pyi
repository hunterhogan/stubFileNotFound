...
class ReadWriteLock:
    ...
    __condition: Incomplete
    __writer: Incomplete
    __upgradewritercount: int
    __pendingwriters: Incomplete
    __readers: Incomplete
    def __init__(self) -> None:
        """Initialize this read-write lock."""
    def acquireRead(self, timeout: Any=None) -> None:
        ...
        """
    __writercount: Incomplete
    def acquireWrite(self, timeout: Any=None) -> None:
