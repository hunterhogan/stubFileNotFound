...
from python_toolbox import context_management as context_management
from typing import Any

@context_management.ContextManagerType
def create_temp_folder(*, prefix: Any=..., suffix: str = '', parent_folder: Any=None, chmod: Any=None) -> Generator[Incomplete]:
    """
