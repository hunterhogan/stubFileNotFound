from .bagging import Bag as Bag, FrozenBag as FrozenBag
...
class FrozenBagBag(FrozenBag):
    ...
    def get_sub_fbbs_for_one_key_removed(self) -> Any:
        """
        ...
        """
    def get_sub_fbbs_for_one_key_and_previous_piles_removed(self) -> Any:
        """
