...
from .various_frozen_dicts import FrozenDict as FrozenDict, FrozenOrderedDict as FrozenOrderedDict
from _typeshed import Incomplete
from python_toolbox import math_tools as math_tools, misc_tools as misc_tools
...
def _count_elements_slow(mapping: Any, iterable: Any) -> None:
    """Put elements from `iterable` into `mapping`."""
_count_elements = _count_elements_slow

def _process_count(count: Any) -> Any:
...
class _BootstrappedCachedProperty(misc_tools.OwnNameDiscoveringDescriptor):
    ...
    def __init__(self, getter_or_value: Any, doc: Any=None, name: Any=None, force_value_not_getter: bool = False) -> None:
        ...
        """
    def __get__(self, obj: Any, our_type: Any=None) -> Any: ...
...
class _BaseBagMixin:
    ...
    def most_common(self, n: Any=None) -> Any:
        """
    ...
    def get_contained_bags(self) -> Any:
        """
...
class _MutableBagMixin(_BaseBagMixin):
    ...
    def __setitem__(self, i: Any, count: Any) -> None: ...
    ...
    def __imod__(self, other: Any) -> Any:
        ...
        really be modified.
        """
    def __ipow__(self, other: Any, modulo: Any=None) -> Any:
...
class _FrozenBagMixin:
    ...
    def frozen_bag_bag(self) -> Any:
        ...
        '''
    def get_mutable(self) -> Any:
        """Get a mutable version of this bag."""
    _contained_bags: Incomplete
    def get_contained_bags(self) -> Any:
        """
        Get all bags that are subsets of this bag.
...
class _BaseDictDelegator(collections.abc.MutableMapping[Any, Any]):
    """
...
class _OrderedDictDelegator(Ordered, _BaseDictDelegator):
    ...
    """
    _dict_type = OrderedDict[Any, Any]
    index: Incomplete
    move_to_end: Incomplete
    sort: Incomplete
...
class OrderedBag(_OrderedBagMixin, _MutableBagMixin, _OrderedDictDelegator):
    ...
    (Similarly to `collections.OrderedDict`.)
    """
...
class FrozenOrderedBag(_OrderedBagMixin, _FrozenBagMixin, _BaseBagMixin, FrozenOrderedDict):
    ...
    Also, unlike `collections.Counter`:
     ...
     -  Items are ordered by insertion order. (Similarly to
