...
def all_equivalent(iterable, relation=..., *, assume_reflexive=..., assume_symmetric=..., assume_transitive=...): # -> bool:
    '''
...
def get_equivalence_classes(iterable, key=..., container=..., *, use_ordered_dict=..., sort_ordered_dict=...): # -> OrderedDict | dict[Any, Any]:
    '''
...
def logic_max(iterable, relation=...): # -> list[Any]:
    '''
