...
def filter_items(d, condition, double=..., force_dict_type=...): # -> tuple[Any, ...] | Any | dict[Any, Any]:
    '''
...
def remove_keys(d, keys_to_remove): # -> None:
    '''
