...
class BaseCuteExecutor(concurrent.futures.Executor):
    ...
    '''
    def filter(self, filter_function, iterable, timeout=..., as_completed=...): # -> Generator[Any, Any, None]:
        '''
    ...
    def map(self, function, *iterables, timeout=..., as_completed=...): # -> Generator[Any, Any, None]:
        '''
