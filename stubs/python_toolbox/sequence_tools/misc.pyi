...
infinity = ...
def are_equal_regardless_of_order(seq1, seq2): # -> bool:
    '''
...
def flatten(iterable): # -> int | list[Any]:
    '''
...
def partitions(sequence, partition_size=..., *, n_partitions=..., allow_remainder=..., larger_on_remainder=..., fill_value=...): # -> list[Any | tuple[Any, ...]]:
    '''
...
def is_immutable_sequence(thing): # -> bool:
    '''Is `thing` an immutable sequence, like `tuple`?'''
    ...

def to_tuple(single_or_sequence, item_type=..., item_test=...): # -> tuple[Any, ...] | tuple[()] | tuple[Any]:
    '''
...
def get_recurrences(sequence): # -> dict[Any, Any]:
    '''
...
def ensure_iterable_is_immutable_sequence(iterable, default_type=..., unallowed_types=...): # -> tuple[Any, ...]:
    '''
...
def ensure_iterable_is_sequence(iterable, default_type=..., unallowed_types=...): # -> tuple[Any, ...]:
    '''
...
def divide_to_slices(sequence, n_slices): # -> list[Any]:
    '''
...
def is_subsequence(big_sequence, small_sequence): # -> Literal[True] | None:
    '''
