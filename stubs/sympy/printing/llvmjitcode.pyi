...
class LLVMJitPrinter(Printer):
    ...
    def _add_tmp_var(self, name, value) -> None: ...
...
class LLVMJitCode:
    ...
    def _create_args(self, func_args) -> None:
        """Create types for function arguments"""
    def _create_function_base(self) -> None:
        """Create function with name and type signature"""
    def _create_param_dict(self, func_args) -> None:
