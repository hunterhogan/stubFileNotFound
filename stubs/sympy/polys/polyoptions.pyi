...
class Domain(Option, metaclass=OptionType):
    ...
    excludes: Incomplete
    after: Incomplete
    _re_realfield: Incomplete
    _re_complexfield: Incomplete
    _re_finitefield: Incomplete
    _re_polynomial: Incomplete
    _re_fraction: Incomplete
    _re_algebraic: Incomplete
    @classmethod
