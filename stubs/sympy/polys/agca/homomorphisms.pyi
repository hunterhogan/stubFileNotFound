...
class ModuleHomomorphism:
    ...
    def _image(self) -> None:
        """Compute the image of ``self``."""
    def _restrict_domain(self, sm) -> None:
        """Implementation of domain restriction."""
    def _restrict_codomain(self, sm) -> None:
        """Implementation of codomain restriction."""
    def _quotient_domain(self, sm) -> None:
        """Implementation of domain quotient."""
    def _quotient_codomain(self, sm) -> None:
    ...
    def quotient_codomain(self, sm):
        ...
        [0, 0]])
        """
    def _apply(self, elem) -> None:
        """Apply ``self`` to ``elem``."""
    def __call__(self, elem): ...
    def _compose(self, oth) -> None:
        """
