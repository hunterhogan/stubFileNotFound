...
class IPolys:
    ...
    def dup_inner_refine_real_root(self, f, M, eps=None, steps=None, disjoint=None, fast: bool = False, mobius: bool = False): ...
    def dup_outer_refine_real_root(self, f, s, t, eps=None, steps=None, disjoint=None, fast: bool = False): ...
    def dup_refine_real_root(self, f, s, t, eps=None, steps=None, disjoint=None, fast: bool = False): ...
    def dup_inner_isolate_real_roots(self, f, eps=None, fast: bool = False): ...
    def dup_inner_isolate_positive_roots(self, f, eps=None, inf=None, sup=None, fast: bool = False, mobius: bool = False): ...
    def dup_inner_isolate_negative_roots(self, f, inf=None, sup=None, eps=None, fast: bool = False, mobius: bool = False): ...
    def dup_isolate_real_roots_sqf(self, f, eps=None, inf=None, sup=None, fast: bool = False, blackbox: bool = False): ...
    def dup_isolate_real_roots(self, f, eps=None, inf=None, sup=None, basis: bool = False, fast: bool = False): ...
    def dup_isolate_real_roots_list(self, polys, eps=None, inf=None, sup=None, strict: bool = False, basis: bool = False, fast: bool = False): ...
    def dup_count_real_roots(self, f, inf=None, sup=None): ...
    def dup_count_complex_roots(self, f, inf=None, sup=None, exclude=None): ...
    def dup_isolate_complex_roots_sqf(self, f, eps=None, inf=None, sup=None, blackbox: bool = False): ...
    def dup_isolate_all_roots_sqf(self, f, eps=None, inf=None, sup=None, fast: bool = False, blackbox: bool = False): ...
    def dup_isolate_all_roots(self, f, eps=None, inf=None, sup=None, fast: bool = False): ...
