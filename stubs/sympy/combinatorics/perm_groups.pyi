...
class PermutationGroup(Basic):
    ...
    def __mul__(self, other):
        ...
        """
    def _random_pr_init(self, r, n, _random_prec_n: Incomplete | None = None) -> None:
    ...
    def _eval_is_alt_sym_monte_carlo(self, eps: float = 0.05, perms: Incomplete | None = None):
    ...
    def schreier_sims(self) -> None:
        ...
        [{0: (2)(0 1), 1: (2), 2: (1 2)},
         {0: (2), 2: (0 2)}]
        """
    def _schreier_sims(self, base: Incomplete | None = None) -> None: ...
