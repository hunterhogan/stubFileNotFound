...
def _perfect_power(n, next_p: int = 2):
    ...
    """
def perfect_power(n, candidates=None, big: bool = True, factor: bool = True):
    """
...
def _factorint_small(factors, n, limit, fail_max, next_p: int = 2):
    """
    ...
    """
def factorint(n, limit=None, use_trial: bool = True, use_rho: bool = True, use_pm1: bool = True, use_ecm: bool = True, verbose: bool = False, visual=None, multiple: bool = False):
    """
    ...
    """
def factorrat(rat, limit=None, use_trial: bool = True, use_rho: bool = True, use_pm1: bool = True, verbose: bool = False, visual=None, multiple: bool = False):
    """
    ...
    """
def primefactors(n, limit=None, verbose: bool = False, **kwargs):
    ...
    """
def _divisors(n, proper: bool = False) -> Generator[Incomplete, Incomplete]:
    ...
    """
@overload
def divisors(n: int, generator: Literal[True], proper: bool = False) -> Generator[int]:...
@overload
def divisors(n: int, generator: Literal[False] = False, proper: bool = False) -> list[int]:...
@overload
def divisors(n: int, generator: bool = False, proper: bool = False) -> list[int] | Generator[int]:...
...
def proper_divisor_count(n, modulus: int = 1):
    ...
    """
def _udivisors(n) -> Generator[Incomplete]:
