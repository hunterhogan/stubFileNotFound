...
def unset_show() -> None:
    ...
    """
def _deprecation_msg_m_a_r_f(attr) -> None: ...
...
class Plot:
    ...
    * close(self): used to close the current plot backend (note: some plotting
    ...
    _markers: Incomplete
    _rectangles: Incomplete
    _fill: Incomplete
    _series: Incomplete
    xlim: Incomplete
    ylim: Incomplete
    size: Incomplete
    def __init__(self, *args, title=None, xlabel=None, ylabel=None, zlabel=None, aspect_ratio: str = 'auto', xlim=None, ylim=None, axis_center: str = 'auto', axis: bool = True, xscale: str = 'linear', yscale: str = 'linear', legend: bool = False, autoscale: bool = True, margin: int = 0, annotations=None, markers=None, rectangles=None, fill=None, backend: str = 'default', size=None, **kwargs) -> None: ...
    @property
    def _backend(self): ...
    @property
    def backend(self): ...
