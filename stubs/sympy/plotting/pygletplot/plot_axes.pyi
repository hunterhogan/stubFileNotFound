...
from sympy.plotting.pygletplot.util import (
	billboard_matrix as billboard_matrix, dot_product as dot_product, get_direction_vectors as get_direction_vectors,
	strided_range as strided_range, vec_mag as vec_mag, vec_sub as vec_sub)
from sympy.utilities.iterables import is_sequence as is_sequence

class PlotAxes(PlotObject):
    _render_object: Incomplete
    _stride: Incomplete
    _tick_length: Incomplete
    _origin: Incomplete
    visible: Incomplete
    _overlay: Incomplete
    _colored: Incomplete
    _label_axes: Incomplete
    _label_ticks: Incomplete
    font_face: Incomplete
    font_size: Incomplete
    def __init__(self, *args, style: str = '', none=None, frame=None, box=None, ordinate=None, stride: float = 0.25, visible: str = '', overlay: str = '', colored: str = '', label_axes: str = '', label_ticks: str = '', tick_length: float = 0.1, font_face: str = 'Arial', font_size: int = 28, **kwargs) -> None: ...
    label_font: Incomplete
    def reset_resources(self) -> None: ...
    _bounding_box: Incomplete
    _axis_ticks: Incomplete
    def reset_bounding_box(self) -> None: ...
    def draw(self) -> None: ...
    def adjust_bounds(self, child_bounds) -> None: ...
    def _recalculate_axis_ticks(self, axis) -> None: ...
