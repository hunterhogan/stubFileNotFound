...
class PygletPlot:
    ...
    def close(self) -> None:
        ...
        """
    def saveimage(self, outfile=None, format: str = '', size=(600, 500)) -> None:
        """
...
class ScreenShot:
    ...
    def _execute_saving(self) -> None: ...
    size: Incomplete
    def save(self, outfile=None, format: str = '', size=(600, 500)) -> None: ...
