...
def strfunc(z): ...
def declare_phy_entities(self, ctx, phy_type, i, j=None) -> None: ...
def declare_frames(self, ctx, i, j=None) -> None: ...
def declare_points(self, ctx, i, j=None) -> None: ...
def declare_particles(self, ctx, i, j=None) -> None: ...
def declare_bodies(self, ctx, i, j=None) -> None: ...
