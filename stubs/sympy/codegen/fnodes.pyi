...
class use(Token):
    ...
    _fields: Incomplete
    defaults: Incomplete
    _construct_namespace: Incomplete
    _construct_rename: Incomplete
...
class Do(Token):
    ...
    defaults: Incomplete
    _construct_body: Incomplete
    _construct_counter: Incomplete
    _construct_first: Incomplete
    _construct_last: Incomplete
...
class FortranReturn(Token):
    ...
    _fields: Incomplete
    defaults: Incomplete
    _construct_return_value: Incomplete
...
class sum_(Token, Expr):
    ...
    _fields: Incomplete
    defaults: Incomplete
    _construct_array: Incomplete
    _construct_dim: Incomplete
