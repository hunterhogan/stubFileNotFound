...
class Expectation(Expr):
    ...
    def _eval_rewrite_as_Integral(self, arg, condition=None, evaluate: bool = False, **kwargs): ...
    _eval_rewrite_as_Sum = _eval_rewrite_as_Integral
    def evaluate_integral(self): ...
...
class Moment(Expr):
    ...
    def _eval_rewrite_as_Probability(self, X, n, c: int = 0, condition=None, **kwargs): ...
    def _eval_rewrite_as_Integral(self, X, n, c: int = 0, condition=None, **kwargs): ...
