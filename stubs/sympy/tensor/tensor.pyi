...
from sympy.combinatorics.tensor_can import (
	bsgs_direct_product as bsgs_direct_product, canonicalize as canonicalize,
	get_symmetric_group_sgs as get_symmetric_group_sgs, riemann_bsgs as riemann_bsgs)
...
from sympy.core.function import WildFunction as WildFunction
...
from sympy.core.sympify import _sympify as _sympify, CantSympify as CantSympify
...
class _TensorDataLazyEvaluator(CantSympify):
    ...
    def _check_permutations_on_data(self, tens, data) -> None: ...
    ...
    @staticmethod
    def _correct_signature_from_indices(data, indices, free, dum, inverse: bool = False):
        """
...
_tensor_data_substitution_dict: Incomplete
...
class _TensorManager:
    ...
    _comm: Incomplete
    _comm_symbols2i: Incomplete
    _comm_i2symbol: Incomplete
...
class TensorIndexType(Basic):
    ...
    def __new__(cls, name, dummy_name=None, dim=None, eps_dim=None, metric_symmetry: int = 1, metric_name: str = 'metric', **kwargs): ...
    @property
    def name(self): ...
    @property
    def dummy_name(self): ...
    ...
    def _components_data_full_destroy(self) -> None:
        """
...
def tensorhead(name, typ, sym=None, comm: int = 0):
    """
...
class TensorHead(Basic):
    ...
    is_commutative: bool
    def __new__(cls, name, index_types, symmetry=None, comm: int = 0): ...
    @property
    def name(self): ...
    @property
    def index_types(self): ...
...
def tensor_heads(s, index_types, symmetry=None, comm: int = 0):
    """
...
class TensExpr(Expr, ABC, metaclass=abc.ABCMeta):
    ...
    def _matches_simple(self, expr, repl_dict=None, old: bool = False):
        """
...
class Tensor(TensExpr):
    ...
    def _set_new_index_structure(self, im, is_canon_bp: bool = False): ...
    def _set_indices(self, *indices, is_canon_bp: bool = False, **kw_args): ...
    def _get_free_indices_set(self): ...
    def _get_dummy_indices_set(self): ...
    def _get_indices_set(self): ...
    @property
    ...
    def _get_symmetrized_forms(self):
        ...
        """
    def matches(self, expr, repl_dict=None, old: bool = False): ...
    def _matches(self, expr, repl_dict=None, old: bool = False):
        """
...
class TensMul(TensExpr, AssocOp):
    ...
    @staticmethod
    def _tensMul_contract_indices(args, replace_indices: bool = True): ...
    @staticmethod
    def _get_components_from_args(args):
        ...
        """
    @staticmethod
    def _rebuild_tensors_list(args, index_structure) -> None: ...
    def doit(self, **hints): ...
    @staticmethod
    ...
    def _set_indices(self, *indices, is_canon_bp: bool = False, **kw_args): ...
    @staticmethod
    def _index_replacement_for_contract_metric(args, free, dum) -> None: ...
    def substitute_indices(self, *index_tuples): ...
    def __call__(self, *indices): ...
    def _extract_data(self, replacement_dict): ...
    @property
...
class WildTensorHead(TensorHead):
    ...
    def __new__(cls, name, index_types=None, symmetry=None, comm: int = 0, unordered_indices: bool = False): ...
    @property
...
class WildTensor(Tensor):
    ...
    def matches(self, expr, repl_dict=None, old: bool = False): ...
    def _match_indices_ignoring_order(self, expr, repl_dict=None, old: bool = False):
        """
