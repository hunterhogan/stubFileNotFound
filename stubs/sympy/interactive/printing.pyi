...
def init_printing(pretty_print: bool = True, order=None, use_unicode=None, use_latex=None, wrap_line=None, num_columns=None, no_global: bool = False, ip=None, euler: bool = False, forecolor=None, backcolor: str = 'Transparent', fontsize: str = '10pt', latex_mode: str = 'plain', print_builtin: bool = True, str_printer=None, pretty_printer=None, latex_printer=None, scale: float = 1.0, **settings):
    """
