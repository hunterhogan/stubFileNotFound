...
__all__ = ["Font", "Axis", "Glyph", "Master", "Instance", "Guide", "Anchor", "Layer", "Shape", "Transform", "Node", "Names", "Color", "Position", "I18NDictionary", "Convert", "BaseConvertor", "Features", "load"]
def load(filename):
    ...
