...
__all__ = ["compileInterpolatableOTFsFromDS", "compileInterpolatableTTFs", "compileInterpolatableTTFsFromDS", "compileOTF", "compileTTF", "compileVariableCFF2", "compileVariableCFF2s", "compileVariableTTF", "compileVariableTTFs"]
def compileTTF(ufo, **kwargs): # -> Any:
...
def compileInterpolatableTTFs(ufos, **kwargs): # -> Generator[Any, Any, None]:
...
def compileVariableTTFs(designSpaceDoc, **kwargs): # -> dict[Any, Any]:
...
def compileVariableCFF2s(designSpaceDoc, **kwargs): # -> dict[Any, Any]:
    """Create FontTools TrueType variable fonts for each variable font defined
    in the given DesignSpaceDocument, using their UFO sources
    with interpolatable outlines, using fontTools.varLib.build.
