...
from typing import Any, Dict, List, Optional, Tuple, TYPE_CHECKING, TypeAlias, Union
...
if TYPE_CHECKING:
    ...
NameRecordDict: TypeAlias = dict[str, Any]
logger = ...
FontMathObject: TypeAlias = fontMath.MathGlyph | fontMath.MathInfo | fontMath.MathKerning
Location: TypeAlias = Mapping[str, float]
LocationKey: TypeAlias = tuple[tuple[str, float], ...]
AxisBounds: TypeAlias = dict[str, tuple[float, float, float]]
SourceLayer: TypeAlias = tuple[Location, dict[str, Glyph]]
...
class Instantiator:
    ...
    glyph_mutators: Mapping[str, Variator | None] = ...
    info_mutator: Variator | None = ...
    kerning_mutator: Variator | None = ...
    round_geometry: bool = ...
...
def italic_angle_from_slnt_value(slnt_user_value) -> int | float:
