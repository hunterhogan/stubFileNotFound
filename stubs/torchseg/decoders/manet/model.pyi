...
from .decoder import MAnetDecoder as MAnetDecoder
from _typeshed import Incomplete
from typing import Callable

class MAnet(SegmentationModel):
    '''
    MAnet_ :  Multi-scale Attention Net. The MA-Net can capture rich contextual
    dependencies based on the attention mechanism, using two blocks:
        - Position-wise Attention Block (PAB), which captures the spatial dependencies
            between pixels in a global view
    ...
    Args:
        ...
        decoder_channels: List of integers which specify **in_channels** parameter
            for convolutions used in decoder. Length of the list should be
    ...
    name: Incomplete
    def __init__(self, encoder_name: str = 'resnet34', encoder_indices: tuple[int] | None = None, encoder_depth: int = 5, encoder_output_stride: int = 32, encoder_weights: str | None = 'imagenet', decoder_use_batchnorm: bool = True, decoder_channels: list[int] = (256, 128, 64, 32, 16), decoder_pab_channels: int = 64, in_channels: int = 3, classes: int = 1, activation: Callable = ..., encoder_params: dict = {}, aux_params: dict | None = None) -> None: ...
