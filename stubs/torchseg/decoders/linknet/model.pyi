...
from .decoder import LinknetDecoder as LinknetDecoder
from _typeshed import Incomplete
from typing import Callable

class Linknet(SegmentationModel):
    '''
    Linknet_ is a fully convolution neural network for image semantic segmentation.
    ...
    by decoder to define accurate segmentation mask. Use *sum* for fusing decoder
    ...
    Args:
        ...
        decoder_use_batchnorm: If **True**, BatchNorm2d layer between Conv2D and
            Activation layers is used. Available options are **True, False, "inplace"**
    ...
    name: Incomplete
    def __init__(self, encoder_name: str = 'resnet34', encoder_indices: tuple[int] | None = None, encoder_depth: int = 5, encoder_output_stride: int = 32, encoder_weights: str | None = 'imagenet', decoder_use_batchnorm: bool = True, in_channels: int = 3, classes: int = 1, activation: Callable = ..., encoder_params: dict = {}, aux_params: dict | None = None) -> None: ...
