...
class DeepLabV3(SegmentationModel):
    ...
    Args:
        ...
        encoder_depth: A number of stages used in encoder in range [3, 5].
            Each stage generate features two times smaller in spatial dimensions than
            previous one (e.g. for depth 0 we will have features with shapes
            [(N, C, H, W),], for depth 1 - [(N, C, H, W), (N, C, H // 2, W // 2)]
    ...
    def __init__(self, encoder_name: str = 'resnet34', encoder_indices: tuple[int] | None = None, encoder_depth: int = 5, encoder_output_stride: int = 8, encoder_weights: str | None = 'imagenet', decoder_channels: int = 256, in_channels: int = 3, classes: int = 1, activation: Callable = ..., upsampling: int = 8, encoder_params: dict | None = {}, aux_params: dict | None = None) -> None: ...
...
class DeepLabV3Plus(SegmentationModel):
    ...
    segmentation_head: Incomplete
    classification_head: Incomplete
    def __init__(self, encoder_name: str = 'resnet34', encoder_indices: tuple[int] | None = None, encoder_depth: int = 5, encoder_weights: str | None = 'imagenet', encoder_output_stride: int = 16, decoder_channels: int = 256, decoder_atrous_rates: tuple = (12, 24, 36), in_channels: int = 3, classes: int = 1, activation: Callable = ..., upsampling: int = 4, encoder_params: dict | None = {}, aux_params: dict | None = None) -> None: ...
