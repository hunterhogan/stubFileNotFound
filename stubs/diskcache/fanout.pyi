from .core import (
	Cache as Cache, DEFAULT_SETTINGS as DEFAULT_SETTINGS, Disk as Disk, ENOVAL as ENOVAL, Timeout as Timeout)
...
class FanoutCache:
	...
	_deques: list[Deque]
	_indexes: Index
	def __init__(self, directory: str | None = None, shards: int = 8, timeout: float = 0.01, disk: 'Disk' = ..., **settings: Any) -> None:
	...
	@cl.contextmanager
	def transact(self, retry: bool = True) -> Generator[None, Any, None]:
		...
		"""
	def set(self, key: str, value: object, expire: float | None = None, read: bool = False, tag: str | None = None, retry: bool = False) -> bool:
	...
	def touch(self, key: str, expire: float | None = None, retry: bool = False) -> bool:
		...
		"""
	def add(self, key: str, value: object, expire: float | None = None, read: bool = False, tag: str | None = None, retry: bool = False) -> bool:
	...
	def decr(self, key, delta=..., default=..., retry=...): # -> int | Any | None:
		...
		"""
	def get(self, key: str, default: object = None, read: bool = False, expire_time: bool = False, tag: bool = False, retry: bool = False) -> tuple[Any | None, None, None] | tuple[Any | None, None] | tuple[bytes | Any | BufferedReader[_BufferedReaderStream] | str | None, Any, Any] | tuple[bytes | Any | BufferedReader[_BufferedReaderStream] | str | None, Any] | bytes | BufferedReader[_BufferedReaderStream] | str | Any | None:
		...
		"""
	def __getitem__(self, key: str) -> tuple[Any | None, None, None] | tuple[Any | None, None] | tuple[bytes | Any | BufferedReader[_BufferedReaderStream] | str | None, Any, Any] | tuple[bytes | Any | BufferedReader[_BufferedReaderStream] | str | None, Any] | bytes | BufferedReader[_BufferedReaderStream] | str | Any | None:
		...
		"""
	def read(self, key: str) -> tuple[Any | None, None, None] | tuple[Any | None, None] | tuple[bytes | Any | BufferedReader[_BufferedReaderStream] | str | None, Any, Any] | tuple[bytes | Any | BufferedReader[_BufferedReaderStream] | str | None, Any] | bytes | BufferedReader[_BufferedReaderStream] | str | Any | None:
	...
	def pop(self, key: str, default: object = None, expire_time: bool = False, tag: bool = False, retry: bool = False) -> tuple[Any | None, None, None] | tuple[Any | None, None] | tuple[bytes | Any | BufferedReader[_BufferedReaderStream] | str | None, Any, Any] | tuple[bytes | Any | BufferedReader[_BufferedReaderStream] | str | None, Any] | bytes | BufferedReader[_BufferedReaderStream] | str | Any | None:
	...
	def check(self, fix: bool = False, retry: bool = False) -> list[str]:
		...
		"""
	def expire(self, retry: bool = False) -> int:
	...
	def clear(self, retry: bool = False) -> int:
		...
		"""
	def _remove(self, name: str, args: tuple[Any, ...] = (), retry: bool = False) -> Any: ...
	...
	def __setstate__(self, state: tuple[str, int, Any, type[Any]]) -> None:
		...
	...
	def reset(self, key: str, value: Any = ...) -> Any | Constant:
		...
		"""
	def cache(self, name: str, timeout: int = 60, disk: 'Disk' | None = None, **settings: Any) -> 'Cache':
		...
		"""
	def deque(self, name: str, maxlen: int | None = None) -> 'Deque':
