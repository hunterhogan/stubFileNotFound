...
class FanoutCache:
    ...
    _deques: Incomplete
    _indexes: Incomplete
    def __init__(self, directory=None, shards: int = 8, timeout: float = 0.01, disk=..., **settings) -> None:
    ...
    @cl.contextmanager
    def transact(self, retry: bool = True) -> Generator[None]:
        ...
        """
    def set(self, key, value, expire=None, read: bool = False, tag=None, retry: bool = False):
    ...
    def __setitem__(self, key, value) -> None:
        ...
        """
    def touch(self, key, expire=None, retry: bool = False):
        ...
        """
    def add(self, key, value, expire=None, read: bool = False, tag=None, retry: bool = False):
    ...
    def clear(self, retry: bool = False):
        ...
        """
    def _remove(self, name, args=(), retry: bool = False): ...
    ...
    def reset(self, key, value=...):
        ...
        """
    def cache(self, name, timeout: int = 60, disk=None, **settings):
