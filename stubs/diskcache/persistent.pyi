...
class Deque(Sequence):
	...
	_cache: Incomplete
	_maxlen: Incomplete
	def __init__(self, iterable=(), directory=None, maxlen=None) -> None:
	...
	__hash__: Incomplete
	@contextmanager
	def transact(self) -> Generator[None]:
...
class Index(MutableMapping):
	...
	def popitem(self, last: bool = True):
		...
		"""
	def push(self, value, prefix=None, side: str = 'back'):
		...
		'''
	def pull(self, prefix=None, default=(None, None), side: str = 'front'):
	...
	def __ne__(self, other):
		...
		"""
	def memoize(self, name=None, typed: bool = False, ignore=()):
