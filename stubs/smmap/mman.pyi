...
class WindowCursor:
    ...
    **Note:**: The current implementation is suited for static and sliding window managers, but it also means
    ...
    __slots__ = ...
    def __init__(self, manager=..., regions=...) -> None:
        ...
    ...
    def use_region(self, offset=..., size=..., flags=...): # -> Self:
    ...
    def buffer(self): # -> memoryview[int]:
...
class StaticWindowMapManager:
    ...
    _MB_in_bytes = ...
    def __init__(self, window_size=..., max_memory_size=..., max_open_handles=...) -> None:
    ...
    def make_cursor(self, path_or_fd): # -> WindowCursorCls:
        """
    ...
    def mapped_memory_size(self): # -> int:
        """:return: amount of bytes currently mapped in total"""

    def max_file_handles(self): # -> int:
        """:return: maximum amount of handles we may have opened"""

    def max_mapped_memory_size(self): # -> int:
        """:return: maximum amount of memory we may allocate"""

    def force_map_handle_removal_win(self, base_path): # -> int:
