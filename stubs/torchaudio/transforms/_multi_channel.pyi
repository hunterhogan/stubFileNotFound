...
class PSD(torch.nn.Module):
    ...
    def forward(self, specgram: torch.Tensor, mask: Optional[torch.Tensor] = ...): # -> Tensor:
        """
        Args:
...
class MVDR(torch.nn.Module):
    ...
    """
    def __init__(self, ref_channel: int = ..., solution: str = ..., multi_mask: bool = ..., diag_loading: bool = ..., diag_eps: float = ..., online: bool = ...) -> None:
        ...
    
    def forward(self, specgram: torch.Tensor, mask_s: torch.Tensor, mask_n: Optional[torch.Tensor] = ...) -> torch.Tensor:
...
class RTFMVDR(torch.nn.Module):
    ...
    .. math::
        ...
        {{\bm{v}^{\mathsf{H}}}(f){\bf{\Phi}_{\textbf{NN}}^{-1}}(f){\bm{v}}(f)}
    """
    def forward(self, specgram: Tensor, rtf: Tensor, psd_n: Tensor, reference_channel: Union[int, Tensor], diagonal_loading: bool = ..., diag_eps: float = ..., eps: float = ...) -> Tensor:
        """
        Args:
            specgram (torch.Tensor): Multi-channel complex-valued spectrum.
                Tensor with dimensions `(..., channel, freq, time)`
...
class SoudenMVDR(torch.nn.Module):
    ...
    .. math::
        ...
        {\text{Trace}({{{\bf{\Phi}_{\textbf{NN}}^{-1}}(f) \bf{\Phi}_{\textbf{SS}}}(f))}}\bm{u}
    """
    def forward(self, specgram: Tensor, psd_s: Tensor, psd_n: Tensor, reference_channel: Union[int, Tensor], diagonal_loading: bool = ..., diag_eps: float = ..., eps: float = ...) -> torch.Tensor:
        """
        Args:
            specgram (torch.Tensor): Multi-channel complex-valued spectrum.
                Tensor with dimensions `(..., channel, freq, time)`.
