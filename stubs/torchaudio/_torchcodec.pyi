...
def load_with_torchcodec(uri: Union[BinaryIO, str, os.PathLike], frame_offset: int = ..., num_frames: int = ..., normalize: bool = ..., channels_first: bool = ..., format: Optional[str] = ..., buffer_size: int = ..., backend: Optional[str] = ...) -> Tuple[torch.Tensor, int]:
...
def save_with_torchcodec(uri: Union[str, os.PathLike], src: torch.Tensor, sample_rate: int, channels_first: bool = ..., format: Optional[str] = ..., encoding: Optional[str] = ..., bits_per_sample: Optional[int] = ..., buffer_size: int = ..., backend: Optional[str] = ..., compression: Optional[Union[float, int]] = ...) -> None:
