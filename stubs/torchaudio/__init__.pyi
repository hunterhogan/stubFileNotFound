...
from . import _extension, compliance, datasets, functional, models, pipelines, transforms, utils
from ._torchcodec import load_with_torchcodec, save_with_torchcodec
from .version import __version__, git_version

def load(uri: Union[BinaryIO, str, os.PathLike], frame_offset: int = ..., num_frames: int = ..., normalize: bool = ..., channels_first: bool = ..., format: Optional[str] = ..., buffer_size: int = ..., backend: Optional[str] = ...) -> Tuple[torch.Tensor, int]:
...
def save(uri: Union[str, os.PathLike], src: torch.Tensor, sample_rate: int, channels_first: bool = ..., format: Optional[str] = ..., encoding: Optional[str] = ..., bits_per_sample: Optional[int] = ..., buffer_size: int = ..., backend: Optional[str] = ..., compression: Optional[Union[float, int]] = ...) -> None:
...
__all__ = ["load", "load_with_torchcodec", "save_with_torchcodec", "save", "compliance", "datasets", "functional", "models", "pipelines", "utils", "transforms"]
