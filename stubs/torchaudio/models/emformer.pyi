...
class _EmformerAttention(torch.nn.Module):
    ...
    """
    def __init__(self, input_dim: int, num_heads: int, dropout: float = ..., weight_init_gain: Optional[float] = ..., tanh_on_mem: bool = ..., negative_inf: float = ...) -> None:
        ...
...
class _EmformerLayer(torch.nn.Module):
    ...
    Args:
        ...
        negative_inf (float, optional): value to use for negative infinity in attention weights. (Default: -1e8)
    """
    def __init__(self, input_dim: int, num_heads: int, ffn_dim: int, segment_length: int, dropout: float = ..., activation: str = ..., left_context_length: int = ..., max_memory_size: int = ..., weight_init_gain: Optional[float] = ..., tanh_on_mem: bool = ..., negative_inf: float = ...) -> None:
        ...
...
class _EmformerImpl(torch.nn.Module):
    def __init__(self, emformer_layers: torch.nn.ModuleList, segment_length: int, left_context_length: int = ..., right_context_length: int = ..., max_memory_size: int = ...) -> None:
        ...
...
class Emformer(_EmformerImpl):
    ...
    *Emformer: Efficient Memory Transformer Based Acoustic Model for Low Latency Streaming Speech Recognition*
    ...
    """
    def __init__(self, input_dim: int, num_heads: int, ffn_dim: int, num_layers: int, segment_length: int, dropout: float = ..., activation: str = ..., left_context_length: int = ..., right_context_length: int = ..., max_memory_size: int = ..., weight_init_scale_strategy: Optional[str] = ..., tanh_on_mem: bool = ..., negative_inf: float = ...) -> None:
        ...
