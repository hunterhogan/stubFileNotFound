...
class DPRNN(nn.Module):
    ...
    """
    def __init__(self, feat_dim: int = ..., hidden_dim: int = ..., num_blocks: int = ..., rnn_type: str = ..., d_model: int = ..., chunk_size: int = ..., chunk_stride: int = ...) -> None:
        ...
...
def squim_objective_model(feat_dim: int, win_len: int, d_model: int, nhead: int, hidden_dim: int, num_blocks: int, rnn_type: str, chunk_size: int, chunk_stride: Optional[int] = ...) -> SquimObjective:
