...
class _Postnet(nn.Module):
    ...
    """
    def __init__(self, n_mels: int, postnet_embedding_dim: int, postnet_kernel_size: int, postnet_n_convolution: int) -> None:
        ...
...
class Tacotron2(nn.Module):
    ...
    """
    def __init__(self, mask_padding: bool = ..., n_mels: int = ..., n_symbol: int = ..., n_frames_per_step: int = ..., symbol_embedding_dim: int = ..., encoder_embedding_dim: int = ..., encoder_n_convolution: int = ..., encoder_kernel_size: int = ..., decoder_rnn_dim: int = ..., decoder_max_step: int = ..., decoder_dropout: float = ..., decoder_early_stopping: bool = ..., attention_rnn_dim: int = ..., attention_hidden_dim: int = ..., attention_location_n_filter: int = ..., attention_location_kernel_size: int = ..., attention_dropout: float = ..., prenet_dim: int = ..., postnet_n_convolution: int = ..., postnet_kernel_size: int = ..., postnet_embedding_dim: int = ..., gate_threshold: float = ...) -> None:
        ...
    ...
    @torch.jit.export
    def infer(self, tokens: Tensor, lengths: Optional[Tensor] = ...) -> Tuple[Tensor, Tensor, Tensor]:
