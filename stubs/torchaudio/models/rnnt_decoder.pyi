...
class RNNTBeamSearch(torch.nn.Module):
    ...
    """
    def __init__(self, model: RNNT, blank: int, temperature: float = ..., hypo_sort_key: Optional[Callable[[Hypothesis], float]] = ..., step_max_tokens: int = ...) -> None:
        ...
    ...
    @torch.jit.export
    def infer(self, input: torch.Tensor, length: torch.Tensor, beam_width: int, state: Optional[List[List[torch.Tensor]]] = ..., hypothesis: Optional[List[Hypothesis]] = ...) -> Tuple[List[Hypothesis], List[List[torch.Tensor]]]:
