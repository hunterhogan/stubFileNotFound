...
class ConvLayerBlock(Module):
    ...
    def __init__(self, in_channels: int, out_channels: int, kernel_size: int, stride: int, bias: bool, layer_norm: Optional[Module]) -> None:
        ...
...
class SelfAttention(Module):
    ...
    def forward(self, x: Tensor, attention_mask: Optional[Tensor] = ..., position_bias: Optional[Tensor] = ..., key_padding_mask: Optional[Tensor] = ...) -> Tuple[Tensor, Optional[Tensor]]:
        """
        Args:
...
class FeedForward(Module):
    ...
    def __init__(self, io_features: int, intermediate_features: int, intermediate_dropout: float, output_dropout: float) -> None:
        ...
...
class Transformer(Module):
    def __init__(self, pos_conv_embed: Module, dropout: float, layers: Module, layer_norm_first: bool, layer_drop: float) -> None:
        ...
    
    def forward(self, x: Tensor, attention_mask: Optional[Tensor] = ..., position_bias: Optional[Tensor] = ...) -> Tensor:
        ...
    
    def get_intermediate_outputs(self, x: Tensor, attention_mask: Optional[Tensor] = ..., num_layers: Optional[int] = ...) -> List[Tensor]:
        ...
...
class Encoder(Module):
    ...
    def forward(self, features: Tensor, lengths: Optional[Tensor] = ...) -> Tensor:
        ...
    
    def extract_features(self, features: Tensor, lengths: Optional[Tensor] = ..., num_layers: Optional[int] = ...) -> List[Tensor]:
        ...
...
class LogitGenerator(Module):
    ...
    """
    def __init__(self, encoder_embed_dim: int, num_classes: int, final_dim: int, skip_masked: bool, skip_nomask: bool) -> None:
        ...
