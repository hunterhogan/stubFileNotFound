...
class ConvBlock(torch.nn.Module):
    ...
    """
    def __init__(self, io_channels: int, hidden_channels: int, kernel_size: int, padding: int, dilation: int = ..., no_residual: bool = ...) -> None:
        ...
...
class MaskGenerator(torch.nn.Module):
    ...
    Note:
        This implementation corresponds to the "non-causal" setting in the paper.
    """
    def __init__(self, input_dim: int, num_sources: int, kernel_size: int, num_feats: int, num_hidden: int, num_layers: int, num_stacks: int, msk_activate: str) -> None:
        ...
...
class ConvTasNet(torch.nn.Module):
    ...
    *Conv-TasNet: Surpassing Ideal Time–Frequency Magnitude Masking for Speech Separation*
    ...
    """
    def __init__(self, num_sources: int = ..., enc_kernel_size: int = ..., enc_num_feats: int = ..., msk_kernel_size: int = ..., msk_num_feats: int = ..., msk_num_hidden_feats: int = ..., msk_num_layers: int = ..., msk_num_stacks: int = ..., msk_activate: str = ...) -> None:
        ...
