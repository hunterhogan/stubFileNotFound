...
class _CustomLSTM(torch.nn.Module):
    ...
    """
    def __init__(self, input_dim: int, hidden_dim: int, layer_norm: bool = ..., layer_norm_epsilon: float = ...) -> None:
        ...
...
class _Predictor(torch.nn.Module):
    ...
    """
    def __init__(self, num_symbols: int, output_dim: int, symbol_embedding_dim: int, num_lstm_layers: int, lstm_hidden_dim: int, lstm_layer_norm: bool = ..., lstm_layer_norm_epsilon: float = ..., lstm_dropout: float = ...) -> None:
        ...
    
    def forward(self, input: torch.Tensor, lengths: torch.Tensor, state: Optional[List[List[torch.Tensor]]] = ...) -> Tuple[torch.Tensor, torch.Tensor, List[List[torch.Tensor]]]:
        r"""Forward pass.
...
class RNNT(torch.nn.Module):
    ...
    def forward(self, sources: torch.Tensor, source_lengths: torch.Tensor, targets: torch.Tensor, target_lengths: torch.Tensor, predictor_state: Optional[List[List[torch.Tensor]]] = ...) -> Tuple[torch.Tensor, torch.Tensor, torch.Tensor, List[List[torch.Tensor]]]:
        r"""Forward pass for training.
