...
class _HEncLayer(torch.nn.Module):
    ...
    """
    def __init__(self, chin: int, chout: int, kernel_size: int = ..., stride: int = ..., norm_groups: int = ..., empty: bool = ..., freq: bool = ..., norm_type: str = ..., context: int = ..., dconv_kw: Optional[Dict[str, Any]] = ..., pad: bool = ...) -> None:
        ...
    
    def forward(self, x: torch.Tensor, inject: Optional[torch.Tensor] = ...) -> torch.Tensor:
...
class _HDecLayer(torch.nn.Module):
    ...
    Args:
        ...
        pad (bool, optional): true to pad the input. Padding is done so that the output size is
            always the input size / stride. (Default: ``True``)
    """
    def __init__(self, chin: int, chout: int, last: bool = ..., kernel_size: int = ..., stride: int = ..., norm_groups: int = ..., empty: bool = ..., freq: bool = ..., norm_type: str = ..., context: int = ..., dconv_kw: Optional[Dict[str, Any]] = ..., pad: bool = ...) -> None:
        ...
    
    def forward(self, x: torch.Tensor, skip: Optional[torch.Tensor], length): # -> tuple[Tensor | Any, Tensor]:
...
class HDemucs(torch.nn.Module):
    ...
    *Hybrid Spectrogram and Waveform Source Separation* :cite:`defossez2021hybrid`.
    ...
    """
    def __init__(self, sources: List[str], audio_channels: int = ..., channels: int = ..., growth: int = ..., nfft: int = ..., depth: int = ..., freq_emb: float = ..., emb_scale: int = ..., emb_smooth: bool = ..., kernel_size: int = ..., time_stride: int = ..., stride: int = ..., context: int = ..., context_enc: int = ..., norm_starts: int = ..., norm_groups: int = ..., dconv_depth: int = ..., dconv_comp: int = ..., dconv_attn: int = ..., dconv_lstm: int = ..., dconv_init: float = ...) -> None:
        ...
...
class _DConv(torch.nn.Module):
    ...
    """
    def __init__(self, channels: int, compress: float = ..., depth: int = ..., init: float = ..., norm_type: str = ..., attn: bool = ..., heads: int = ..., ndecay: int = ..., lstm: bool = ..., kernel_size: int = ...) -> None:
        ...
