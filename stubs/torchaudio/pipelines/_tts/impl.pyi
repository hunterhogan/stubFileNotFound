...
class _EnglishCharProcessor(Tacotron2TTSBundle.TextProcessor):
    ...
    @property
    def tokens(self): # -> tuple[Literal['_'], Literal['-'], Literal['!'], Literal['\''], Literal['('], Literal[')'], Literal[','], Literal['.'], Literal[':'], Literal[';'], Literal['?'], Literal[' '], Literal['a'], Literal['b'], Literal['c'], Literal['d'], Literal['e'], Literal['f'], Literal['g'], Literal['h'], Literal['i'], Literal['j'], Literal['k'], Literal['l'], Literal['m'], Literal['n'], Literal['o'], Literal['p'], Literal['q'], Literal['r'], Literal['s'], Literal['t'], Literal['u'], Literal['v'], Literal['w'], Literal['x'], Literal['y'], Literal['z']]:
        ...
...
class _WaveRNNVocoder(torch.nn.Module, Tacotron2TTSBundle.Vocoder):
    def __init__(self, model: WaveRNN, min_level_db: Optional[float] = ...) -> None:
        ...
