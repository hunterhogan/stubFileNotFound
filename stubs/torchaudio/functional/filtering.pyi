...
def bandpass_biquad(waveform: Tensor, sample_rate: int, central_freq: float, Q: float = ..., const_skirt_gain: bool = ...) -> Tensor:
...
def dcshift(waveform: Tensor, shift: float, limiter_gain: Optional[float] = ...) -> Tensor:
...
def flanger(waveform: Tensor, sample_rate: int, delay: float = ..., depth: float = ..., regen: float = ..., width: float = ..., speed: float = ..., phase: float = ..., modulation: str = ..., interpolation: str = ...) -> Tensor:
...
class DifferentiableFIR(torch.autograd.Function):
    @staticmethod
    def forward(ctx, waveform, b_coeffs): # -> Tensor:
        ...
    
    @staticmethod
    def backward(ctx, dy): # -> tuple[Tensor | None, Tensor | None]:
        ...
...
class DifferentiableIIR(torch.autograd.Function):
    @staticmethod
    def forward(ctx, waveform, a_coeffs_normalized): # -> Tensor:
        ...
    
    @staticmethod
    def backward(ctx, dy): # -> tuple[Any | None, Any | None]:
        ...
...
def phaser(waveform: Tensor, sample_rate: int, gain_in: float = ..., gain_out: float = ..., delay_ms: float = ..., decay: float = ..., mod_speed: float = ..., sinusoidal: bool = ...) -> Tensor:
