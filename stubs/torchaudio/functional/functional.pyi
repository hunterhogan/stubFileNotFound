...
__all__ = ["spectrogram", "inverse_spectrogram", "griffinlim", "amplitude_to_DB", "DB_to_amplitude", "compute_deltas", "melscale_fbanks", "linear_fbanks", "create_dct", "compute_deltas", "detect_pitch_frequency", "DB_to_amplitude", "mu_law_encoding", "mu_law_decoding", "phase_vocoder", "mask_along_axis", "mask_along_axis_iid", "sliding_window_cmn", "spectral_centroid", "resample", "edit_distance", "loudness", "pitch_shift", "rnnt_loss", "psd", "mvdr_weights_souden", "mvdr_weights_rtf", "rtf_evd", "rtf_power", "apply_beamforming", "fftconvolve", "convolve", "add_noise", "speed", "preemphasis", "deemphasis"]
def spectrogram(waveform: Tensor, pad: int, window: Tensor, n_fft: int, hop_length: int, win_length: int, power: Optional[float], normalized: Union[bool, str], center: bool = ..., pad_mode: str = ..., onesided: bool = ..., return_complex: Optional[bool] = ...) -> Tensor:
...
def inverse_spectrogram(spectrogram: Tensor, length: Optional[int], pad: int, window: Tensor, n_fft: int, hop_length: int, win_length: int, normalized: Union[bool, str], center: bool = ..., pad_mode: str = ..., onesided: bool = ...) -> Tensor:
...
def griffinlim(specgram: Tensor, window: Tensor, n_fft: int, hop_length: int, win_length: int, power: float, n_iter: int, momentum: float, length: Optional[int], rand_init: bool) -> Tensor:
...
def amplitude_to_DB(x: Tensor, multiplier: float, amin: float, db_multiplier: float, top_db: Optional[float] = ...) -> Tensor:
...
def melscale_fbanks(n_freqs: int, f_min: float, f_max: float, n_mels: int, sample_rate: int, norm: Optional[str] = ..., mel_scale: str = ...) -> Tensor:
...
def mask_along_axis_iid(specgrams: Tensor, mask_param: int, mask_value: Union[float, Tensor], axis: int, p: float = ...) -> Tensor:
...
def detect_pitch_frequency(waveform: Tensor, sample_rate: int, frame_time: float = ..., win_length: int = ..., freq_low: int = ..., freq_high: int = ...) -> Tensor:
...
def sliding_window_cmn(specgram: Tensor, cmn_window: int = ..., min_cmn_window: int = ..., center: bool = ..., norm_vars: bool = ...) -> Tensor:
    r"""
...
def spectral_centroid(waveform: Tensor, sample_rate: int, pad: int, window: Tensor, n_fft: int, hop_length: int, win_length: int) -> Tensor:
...
_CPU = ...
def resample(waveform: Tensor, orig_freq: int, new_freq: int, lowpass_filter_width: int = ..., rolloff: float = ..., resampling_method: str = ..., beta: Optional[float] = ...) -> Tensor:
...
def pitch_shift(waveform: Tensor, sample_rate: int, n_steps: int, bins_per_octave: int = ..., n_fft: int = ..., win_length: Optional[int] = ..., hop_length: Optional[int] = ..., window: Optional[Tensor] = ...) -> Tensor:
    """
...
class RnntLoss(torch.autograd.Function):
    ...
    @staticmethod
    def backward(ctx, dy): # -> tuple[Any, None, None, None, None, None, None, None]:
        ...
    


def rnnt_loss(logits: Tensor, targets: Tensor, logit_lengths: Tensor, target_lengths: Tensor, blank: int = ..., clamp: float = ..., reduction: str = ..., fused_log_softmax: bool = ...): # -> Any | None:
...
def psd(specgram: Tensor, mask: Optional[Tensor] = ..., normalize: bool = ..., eps: float = ...) -> Tensor:
...
def mvdr_weights_souden(psd_s: Tensor, psd_n: Tensor, reference_channel: Union[int, Tensor], diagonal_loading: bool = ..., diag_eps: float = ..., eps: float = ...) -> Tensor:
...
def mvdr_weights_rtf(rtf: Tensor, psd_n: Tensor, reference_channel: Optional[Union[int, Tensor]] = ..., diagonal_loading: bool = ..., diag_eps: float = ..., eps: float = ...) -> Tensor:
    r"""Compute the Minimum Variance Distortionless Response (*MVDR* :cite:`capon1969high`) beamforming weights
...
def rtf_power(psd_s: Tensor, psd_n: Tensor, reference_channel: Union[int, Tensor], n_iter: int = ..., diagonal_loading: bool = ..., diag_eps: float = ...) -> Tensor:
...
def add_noise(waveform: torch.Tensor, noise: torch.Tensor, snr: torch.Tensor, lengths: Optional[torch.Tensor] = ...) -> torch.Tensor:
...
def speed(waveform: torch.Tensor, orig_freq: int, factor: float, lengths: Optional[torch.Tensor] = ...) -> Tuple[torch.Tensor, Optional[torch.Tensor]]:
