...
class VoxCeleb1(Dataset):
    ...
    """
    _ext_audio = ...
    def __init__(self, root: Union[str, Path], download: bool = ...) -> None:
        ...
...
class VoxCeleb1Identification(VoxCeleb1):
    ...
    """
    def __init__(self, root: Union[str, Path], subset: str = ..., meta_url: str = ..., download: bool = ...) -> None:
        ...
...
class VoxCeleb1Verification(VoxCeleb1):
    ...
    Note:
        ...
        the extracted files into the same ``root`` directory.
    """
    def __init__(self, root: Union[str, Path], meta_url: str = ..., download: bool = ...) -> None:
        ...
