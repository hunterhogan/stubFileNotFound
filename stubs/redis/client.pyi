...
class Redis(RedisModuleCommands, CoreCommands, SentinelCommands):
    ...
    single_connection_lock: Incomplete
    connection: Incomplete
    _single_connection_client: Incomplete
    response_callbacks: Incomplete
    def __init__(self, host: str = 'localhost', port: int = 6379, db: int = 0, password: str | None = None, socket_timeout: float | None = None, socket_connect_timeout: float | None = None, socket_keepalive: bool | None = None, socket_keepalive_options: Mapping[int, int | bytes] | None = None, connection_pool: ConnectionPool | None = None, unix_socket_path: str | None = None, encoding: str = 'utf-8', encoding_errors: str = 'strict', decode_responses: bool = False, retry_on_timeout: bool = False, retry: Retry = ..., retry_on_error: list[type[Exception]] | None = None, ssl: bool = False, ssl_keyfile: str | None = None, ssl_certfile: str | None = None, ssl_cert_reqs: str | ssl.VerifyMode = 'required', ssl_ca_certs: str | None = None, ssl_ca_path: str | None = None, ssl_ca_data: str | None = None, ssl_check_hostname: bool = True, ssl_password: str | None = None, ssl_validate_ocsp: bool = False, ssl_validate_ocsp_stapled: bool = False, ssl_ocsp_context: OpenSSL.SSL.Context | None = None, ssl_ocsp_expected_cert: str | None = None, ssl_min_version: ssl.TLSVersion | None = None, ssl_ciphers: str | None = None, max_connections: int | None = None, single_connection_client: bool = False, health_check_interval: int = 0, client_name: str | None = None, lib_name: str | None = 'redis-py', lib_version: str | None = ..., username: str | None = None, redis_connect_func: Callable[[], None] | None = None, credential_provider: CredentialProvider | None = None, protocol: int | None = 2, cache: CacheInterface | None = None, cache_config: CacheConfig | None = None, event_dispatcher: EventDispatcher | None = None) -> None:
        """
