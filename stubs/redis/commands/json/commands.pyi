...
class JSONCommands:
    ...
    def arrappend(self, name: str, path: str | None = ..., *args: list[JsonType]) -> list[int | None]:
        ...
        """
    def arrindex(self, name: str, path: str, scalar: int, start: int | None = None, stop: int | None = None) -> list[int | None]:
        """
    ...
    def mget(self, keys: list[str], path: str) -> list[JsonType]:
        ...
        """
    def set(self, name: str, path: str, obj: JsonType, nx: bool | None = False, xx: bool | None = False, decode_keys: bool | None = False) -> str | None:
        """
    ...
    def mset(self, triplets: list[tuple[str, str, JsonType]]) -> str | None:
        ...
        """
    def merge(self, name: str, path: str, obj: JsonType, decode_keys: bool | None = False) -> str | None:
        """
        ...
        """
    def set_file(self, name: str, path: str, file_name: str, nx: bool | None = False, xx: bool | None = False, decode_keys: bool | None = False) -> str | None:
        """
        ...
        """
    def set_path(self, json_path: str, root_folder: str, nx: bool | None = False, xx: bool | None = False, decode_keys: bool | None = False) -> dict[str, bool]:
        """
        ...
        """
    def strlen(self, name: str, path: str | None = None) -> list[int | None]:
    ...
    def strappend(self, name: str, value: str, path: str | None = ...) -> int | list[int | None]:
        ...
        """
    def debug(self, subcommand: str, key: str | None = None, path: str | None = ...) -> int | list[str]:
