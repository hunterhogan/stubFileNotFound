...
class BFCommands:
    ...
    def madd(self, key, *items):
        ...
        """
    def insert(self, key, items, capacity: Incomplete | None = None, error: Incomplete | None = None, noCreate: Incomplete | None = None, expansion: Incomplete | None = None, noScale: Incomplete | None = None):
        """
        Add to a Bloom Filter `key` multiple `items`.
...
class CFCommands:
    ...
    def create(self, key, capacity, expansion: Incomplete | None = None, bucket_size: Incomplete | None = None, max_iterations: Incomplete | None = None):
        """
...
class TDigestCommands:
    ...
    def add(self, key, values):
        ...
        """
    def merge(self, destination_key, num_keys, *keys, compression: Incomplete | None = None, override: bool = False):
        """
