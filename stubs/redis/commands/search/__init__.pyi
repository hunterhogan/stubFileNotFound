...
class Search(SearchCommands):
    ...
    class BatchIndexer:
        ...
        def add_document(self, doc_id, nosave: bool = False, score: float = 1.0, payload: Incomplete | None = None, replace: bool = False, partial: bool = False, no_create: bool = False, **fields) -> None:
            """
            Add a document to the batch query
            """
        def add_document_hash(self, doc_id, score: float = 1.0, replace: bool = False) -> None:
            """
...
class AsyncSearch(Search, AsyncSearchCommands):
    class BatchIndexer(Search.BatchIndexer):
        ...
        document indexing in pipelines, flushing it every N documents.
        """
        async def add_document(self, doc_id, nosave: bool = False, score: float = 1.0, payload: Incomplete | None = None, replace: bool = False, partial: bool = False, no_create: bool = False, **fields) -> None:
            """
            Add a document to the batch query
            """
        current_chunk: int
