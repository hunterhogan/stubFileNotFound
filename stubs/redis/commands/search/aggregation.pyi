...
class AggregateRequest:
    ...
    """
    _query: Incomplete
    _aggregateplan: Incomplete
    _loadfields: Incomplete
    _loadall: bool
    _max: int
    _with_schema: bool
    _verbatim: bool
    ...
    def load(self, *fields: list[str]) -> AggregateRequest:
        ...
        """
    def group_by(self, fields: list[str], *reducers: Reducer | list[Reducer]) -> AggregateRequest:
        """
    ...
    def sort_by(self, *fields: list[str], **kwargs) -> AggregateRequest:
        ...
        *top-N* style queries
        ...
        ```
        '''
    def filter(self, expressions: str | list[str]) -> AggregateRequest:
        """
