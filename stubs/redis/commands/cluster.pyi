...
class ClusterManagementCommands(ManagementCommands, metaclass=abc.ABCMeta):
    ...
    def cluster_delslotsrange(self, *slots: EncodableT) -> ResponseT:
        ...
        """
    def cluster_failover(self, target_node: TargetNodesT, option: str | None = None) -> ResponseT:
        """
        ...
        """
    def cluster_info(self, target_nodes: TargetNodesT | None = None) -> ResponseT:
        """
    ...
    def cluster_keyslot(self, key: str) -> ResponseT:
        ...
        """
    def cluster_meet(self, host: str, port: int, target_nodes: TargetNodesT | None = None) -> ResponseT:
        """
    ...
    def cluster_replicate(self, target_nodes: TargetNodesT, node_id: str) -> ResponseT:
        ...
        """
    def cluster_reset(self, soft: bool = True, target_nodes: TargetNodesT | None = None) -> ResponseT:
        """
        ...
        """
    def cluster_save_config(self, target_nodes: TargetNodesT | None = None) -> ResponseT:
        """
    ...
    def cluster_get_keys_in_slot(self, slot: int, num_keys: int) -> ResponseT:
        ...
        """
    def cluster_set_config_epoch(self, epoch: int, target_nodes: TargetNodesT | None = None) -> ResponseT:
        """
    ...
    def cluster_setslot_stable(self, slot_id: int) -> ResponseT:
        ...
        For more information see https://redis.io/commands/cluster-setslot
        """
    def cluster_replicas(self, node_id: str, target_nodes: TargetNodesT | None = None) -> ResponseT:
        """
        ...
        """
    def cluster_slots(self, target_nodes: TargetNodesT | None = None) -> ResponseT:
        """
...
class RedisClusterCommands(ClusterMultiKeyCommands, ClusterManagementCommands, ACLCommands, PubSubCommands, ClusterDataAccessCommands, ScriptCommands, FunctionCommands, ModuleCommands, RedisModuleCommands, metaclass=abc.ABCMeta):
    ...
    """
class AsyncRedisClusterCommands(AsyncClusterMultiKeyCommands, AsyncClusterManagementCommands, AsyncACLCommands, AsyncClusterDataAccessCommands, AsyncScriptCommands, AsyncFunctionCommands, AsyncModuleCommands, AsyncRedisModuleCommands, metaclass=abc.ABCMeta):
    """
    A class for all Redis Cluster commands
