...
class HiredisRespSerializer:
    def pack(self, *args: list[Any]) -> Any:
        """Pack a series of arguments into the Redis protocol"""

class PythonRespSerializer:
    _buffer_cutoff: Incomplete
    encode: Incomplete
    def __init__(self, buffer_cutoff: Any, encode: Any) -> None: ...
    def pack(self, *args: Any) -> Any:
        """Pack a series of arguments into the Redis protocol"""

class ConnectionInterface(metaclass=abc.ABCMeta):
    @abstractmethod
    def repr_pieces(self) -> Any: ...
    @abstractmethod
    def register_connect_callback(self, callback: Any) -> Any: ...
    @abstractmethod
    def deregister_connect_callback(self, callback: Any) -> Any: ...
    @abstractmethod
    def set_parser(self, parser_class: Any) -> Any: ...
    @abstractmethod
    ...
    @abstractmethod
    def send_packed_command(self, command: Any, check_health: bool = True) -> Any: ...
    @abstractmethod
    def send_command(self, *args: Any, **kwargs: Any) -> Any: ...
    @abstractmethod
    def can_read(self, timeout: int = 0) -> Any: ...
    @abstractmethod
    def read_response(self, disable_decoding: bool = False, *, disconnect_on_error: bool = True, push_request: bool = False) -> Any: ...
    @abstractmethod
    def pack_command(self, *args: Any) -> Any: ...
    @abstractmethod
    def pack_commands(self, commands: Any) -> Any: ...
    @property
    @abstractmethod
    def handshake_metadata(self) -> dict[bytes, bytes] | dict[str, str]: ...
    @abstractmethod
    def set_re_auth_token(self, token: TokenInterface) -> Any: ...
    @abstractmethod
    def re_auth(self) -> Any: ...
...
class AbstractConnection(ConnectionInterface, metaclass=abc.ABCMeta):
    ...
    def __init__(self, db: int = 0, password: str | None = None, socket_timeout: float | None = None, socket_connect_timeout: float | None = None, retry_on_timeout: bool = False, retry_on_error: Any=..., encoding: str = 'utf-8', encoding_errors: str = 'strict', decode_responses: bool = False, parser_class: Any=..., socket_read_size: int = 65536, health_check_interval: int = 0, client_name: str | None = None, lib_name: str | None = 'redis-py', lib_version: str | None = ..., username: str | None = None, retry: Any | None = None, redis_connect_func: Callable[[], None] | None = None, credential_provider: CredentialProvider | None = None, protocol: int | None = 2, command_packer: Callable[[], None] | None = None, event_dispatcher: EventDispatcher | None = None) -> None:
        """
    ...
    def _construct_command_packer(self, packer: Any) -> Any: ...
    ...
    def deregister_connect_callback(self, callback: Any) -> None:
        ...
        """
    _parser: Incomplete
    def set_parser(self, parser_class: Any) -> None:
        """
    ...
    def connect_check_health(self, check_health: bool = True) -> Any: ...
    @abstractmethod
    def _connect(self) -> Any: ...
    @abstractmethod
    def _host_error(self) -> Any: ...
    def _error_message(self, exception: Any) -> Any: ...
    def on_connect(self) -> None: ...
    def on_connect_check_health(self, check_health: bool = True) -> Any:
        """Initialize the connection, authenticate and select a database"""
    def disconnect(self, *args: Any) -> None:
        """Disconnects from the Redis server"""
    def _send_ping(self) -> None:
        """Send PING, expect PONG in return"""
    def _ping_failed(self, error: Any) -> None:
    ...
    def handshake_metadata(self, value: dict[bytes, bytes] | dict[str, str]) -> Any: ...
    def set_re_auth_token(self, token: TokenInterface) -> Any: ...
...
class Connection(AbstractConnection):
    ...
    def __init__(self, host: str = 'localhost', port: int = 6379, socket_keepalive: bool = False, socket_keepalive_options: Incomplete | None = None, socket_type: int = 0, **kwargs: Any) -> None: ...
    def repr_pieces(self) -> Any: ...
    def _connect(self) -> Any:
...
class CacheProxyConnection(ConnectionInterface):
    ...
    def _on_invalidation_callback(self, data: list[str | list[bytes] | None]) -> Any: ...
    def get_protocol(self) -> Any: ...
    def set_re_auth_token(self, token: TokenInterface) -> Any: ...
    def re_auth(self) -> None: ...
...
class SSLConnection(Connection):
    ...
    def _connect(self) -> Any:
        ...
        """
    def _wrap_socket_with_ssl(self, sock: Any) -> Any:
        """
...
class UnixDomainSocketConnection(AbstractConnection):
    ...
    path: Incomplete
    socket_timeout: Incomplete
    def __init__(self, path: str = '', socket_timeout: Incomplete | None = None, **kwargs: Any) -> None: ...
    def repr_pieces(self) -> Any: ...
    def _connect(self) -> Any:
...
class ConnectionPool:
    ...
    """
    @classmethod
    def from_url(cls, url: str, **kwargs: Any) -> _CP:
        '''
    ...
    _lock: Incomplete
    def __init__(self, connection_class: Any=..., max_connections: int | None = None, cache_factory: CacheFactoryInterface | None = None, **connection_kwargs: Any) -> None: ...
    ...
    def get_connection(self, command_name: Incomplete | None = None, *keys: Any, **options: Any) -> Connection:
    ...
    def re_auth_callback(self, token: TokenInterface) -> Any: ...
    async def _mock(self, error: RedisError) -> Any:
        """
...
class BlockingConnectionPool(ConnectionPool):
    ...
    timeout: Incomplete
    def __init__(self, max_connections: int = 50, timeout: int = 20, connection_class: Any=..., queue_class: Any=..., **connection_kwargs: Any) -> None: ...
    pool: Incomplete
    ...
    def get_connection(self, command_name: Incomplete | None = None, *keys: Any, **options: Any) -> Any:
        """
