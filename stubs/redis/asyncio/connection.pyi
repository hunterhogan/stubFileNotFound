...
class ConnectCallbackProtocol(Protocol):
    def __call__(self, connection: AbstractConnection) -> Any: ...

class AsyncConnectCallbackProtocol(Protocol):
    async def __call__(self, connection: AbstractConnection) -> Any: ...
...
class AbstractConnection(metaclass=abc.ABCMeta):
    ...
    async def connect_check_health(self, check_health: bool = True) -> Any: ...
    @abstractmethod
    ...
    async def _ping_failed(self, error: Any) -> None:
    ...
    async def read_response(self, disable_decoding: bool = False, timeout: float | None = None, *, disconnect_on_error: bool = True, push_request: bool | None = False) -> Any:
        """Read the response from a previously sent command"""
    def pack_command(self, *args: EncodableT) -> list[bytes]:
        """Pack a series of arguments into the Redis protocol"""
    def pack_commands(self, commands: Iterable[Iterable[EncodableT]]) -> list[bytes]:
        """Pack multiple commands into the Redis protocol"""
    def _socket_is_empty(self) -> Any:
...
class Connection(AbstractConnection):
    ...
    def __init__(self, *, host: str = 'localhost', port: str | int = 6379, socket_keepalive: bool = False, socket_keepalive_options: Mapping[int, int | bytes] | None = None, socket_type: int = 0, **kwargs: Any) -> None: ...
    def repr_pieces(self) -> Any: ...
    def _connection_arguments(self) -> Mapping[Any, Any]: ...
    _reader: Incomplete
    _writer: Incomplete
...
class SSLConnection(Connection):
    ...
    def __init__(self, ssl_keyfile: str | None = None, ssl_certfile: str | None = None, ssl_cert_reqs: str | ssl.VerifyMode = 'required', ssl_ca_certs: str | None = None, ssl_ca_data: str | None = None, ssl_check_hostname: bool = True, ssl_min_version: TLSVersion | None = None, ssl_ciphers: str | None = None, **kwargs: Any) -> None: ...
    def _connection_arguments(self) -> Mapping[Any, Any]: ...
    @property
    def keyfile(self) -> Any: ...
    @property
    def certfile(self) -> Any: ...
    @property
    def cert_reqs(self) -> Any: ...
    @property
    def ca_certs(self) -> Any: ...
    @property
    def ca_data(self) -> Any: ...
    @property
    def check_hostname(self) -> Any: ...
    @property
    def min_version(self) -> Any: ...
...
class ConnectionPool:
    ...
    _lock: Incomplete
    _event_dispatcher: Incomplete
    def __init__(self, connection_class: type[AbstractConnection] = ..., max_connections: int | None = None, **connection_kwargs: Any) -> None: ...
    def __repr__(self) -> str: ...
    def reset(self) -> None: ...
    def can_get_connection(self) -> bool:
        """Return True if a connection can be retrieved from the pool."""
    async def get_connection(self, command_name: Incomplete | None = None, *keys: Any, **options: Any) -> Any: ...
    def get_available_connection(self) -> Any:
    ...
    async def ensure_connection(self, connection: AbstractConnection) -> Any:
        """Ensure that the connection object is connected and valid"""
    async def release(self, connection: AbstractConnection) -> Any:
        """Releases the connection back to the pool"""
    async def disconnect(self, inuse_connections: bool = True) -> Any:
        """
    ...
    async def re_auth_callback(self, token: TokenInterface) -> Any: ...
...
class BlockingConnectionPool(ConnectionPool):
    ...
    timeout: Incomplete
    def __init__(self, max_connections: int = 50, timeout: int | None = 20, connection_class: type[AbstractConnection] = ..., queue_class: type[asyncio.Queue[Any]] = ..., **connection_kwargs: Any) -> None: ...
    async def get_connection(self, command_name: Incomplete | None = None, *keys: Any, **options: Any) -> Any:
