...
class Lock:
    ...
    def __init__(self, redis: Redis | RedisCluster, name: str | bytes | memoryview, timeout: float | None = None, sleep: float = 0.1, blocking: bool = True, blocking_timeout: Number | None = None, thread_local: bool = True, raise_on_release_error: bool = True) -> None:
        '''
