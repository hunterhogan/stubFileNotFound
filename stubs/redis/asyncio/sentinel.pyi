...
class SentinelManagedConnection(Connection):
    ...
    async def read_response(self, disable_decoding: bool = False, timeout: float | None = None, *, disconnect_on_error: float | None = True, push_request: bool | None = False): ...
...
class Sentinel(AsyncSentinelCommands):
    ...
    def __init__(self, sentinels, min_other_sentinels: int = 0, sentinel_kwargs: Incomplete | None = None, force_master_ip: Incomplete | None = None, **connection_kwargs) -> None: ...
