...
class SentinelManagedConnection(Connection):
    ...
    async def connect_to(self, address: Any) -> None: ...
    async def _connect_retry(self) -> Any: ...
    async def connect(self) -> Any: ...
    async def read_response(self, disable_decoding: bool = False, timeout: float | None = None, *, disconnect_on_error: float | None = True, push_request: bool | None = False) -> Any: ...
...
class SentinelConnectionPool(ConnectionPool):
    ...
    def __repr__(self) -> str: ...
    def reset(self) -> None: ...
    def owns_connection(self, connection: Connection) -> Any: ...
    async def get_master_address(self) -> Any: ...
...
class Sentinel(AsyncSentinelCommands):
    ...
    async def discover_master(self, service_name: str) -> Any:
        """
    ...
    def master_for(self, service_name: str, redis_class: type[Redis] = ..., connection_pool_class: type[SentinelConnectionPool] = ..., **kwargs: Any) -> Any:
        """
        ...
        """
    def slave_for(self, service_name: str, redis_class: type[Redis] = ..., connection_pool_class: type[SentinelConnectionPool] = ..., **kwargs: Any) -> Any:
        """
