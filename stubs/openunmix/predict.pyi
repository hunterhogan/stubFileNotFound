...
def separate(audio, rate=None, model_str_or_path: str = 'umxl', targets=None, niter: int = 1, residual: bool = False, wiener_win_len: int = 300, aggregate_dict=None, separator=None, device=None, filterbank: str = 'torch'):
    '''
