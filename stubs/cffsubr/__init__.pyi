...
__all__ = ["Error", "desubroutinize", "has_subroutines", "subroutinize"]
...
if sys.platform == "win32":
    ...
def subroutinize(otf: ttLib.TTFont, cff_version: int | None = ..., keep_glyph_names: bool = ..., inplace: bool = ...) -> ttLib.TTFont:
