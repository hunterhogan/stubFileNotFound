...
logger: Incomplete
timer: Incomplete
FEATURE_WRITERS_KEY: str
FILTERS_KEY: str
PUBLIC_PREFIX: str
GLYPHS_PREFIX: str
KEEP_GLYPHS_OLD_KEY: str
REMOVE_GLYPHS_OLD_KEY: str
KEEP_GLYPHS_NEW_KEY: str
REMOVE_GLYPHS_NEW_KEY: str
GLYPH_EXPORT_KEY: str
COMPAT_CHECK_KEY: str
INTERPOLATABLE_OUTPUTS: frozenset
AUTOHINTING_PARAMETERS: str
...
class CurveConversion(enum.Enum):
    ...
    ALL_CUBIC_TO_QUAD: ClassVar[CurveConversion] = 'cu2qu'
    MIXED_CUBIC_TO_QUAD: ClassVar[CurveConversion] = 'mixed'
    KEEP_QUAD: ClassVar[CurveConversion] = 'keep-quad'
    KEEP_CUBIC: ClassVar[CurveConversion] = 'keep-cubic'
    @staticmethod
