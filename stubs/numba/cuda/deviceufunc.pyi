...
class DeviceVectorize(_BaseUFuncBuilder):
    ...
    def __init__(self, func, identity=None, cache: bool = False, targetoptions=None) -> None: ...
    @property
    def pyfunc(self): ...
...
class DeviceGUFuncVectorize(_BaseUFuncBuilder):
    ...
    signature: Incomplete
    kernelmap: Incomplete
    def __init__(self, func, sig, identity=None, cache: bool = False, targetoptions=None, writable_args=()) -> None: ...
    @property
    def pyfunc(self): ...
    def add(self, sig=None) -> None: ...
    def _compile_kernel(self, fnobj, sig) -> None: ...
