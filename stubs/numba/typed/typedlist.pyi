...
class List(MutableSequence, pt.Generic[T]):
    ...
    def __new__(cls, *args, lsttype: Incomplete | None = None, meminfo: Incomplete | None = None, allocated=0, **kwargs): ...
    @classmethod
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        """
    def _parse_arg(self, lsttype, meminfo: Incomplete | None = None, allocated=0): ...
    @property
...
def typedlist_empty(cls, item_type, allocated=0): ...
