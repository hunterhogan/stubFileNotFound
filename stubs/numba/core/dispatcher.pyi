...
from numba.core import (
	compiler as compiler, config as config, entrypoints as entrypoints, errors as errors, serialize as serialize,
	sigutils as sigutils, typing as typing, utils as utils)
...
class _DispatcherBase(_dispatcher.Dispatcher):
    ...
    def inspect_asm(self, signature=None):
        ...
        asm : dict[signature, str] or str
            ...
            code.
        """
    def inspect_types(self, file=None, signature=None, pretty: bool = False, style: str = 'default', **kwargs):
...
class Dispatcher(serialize.ReduceMixin, _MemoMixin, _DispatcherBase):
    ...
    _type: Incomplete
    def __init__(self, py_func, locals=None, targetoptions=None, pipeline_class=...) -> None:
        """
        Parameters
        ----------
    ...
    @property
    def stats(self): ...
    def parallel_diagnostics(self, signature=None, level: int = 1) -> None:
        """
