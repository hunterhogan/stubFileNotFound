...
type ErrorModel = Literal['python', 'numpy']
type InLine = Literal['never', 'always']

@overload
def jit[R, **P](
	signature_or_function: Callable[P, R],
	*,
	locals: dict[str, Any] = {},
	cache: bool = False,
...
@overload
def jit[R, **P](
	signature_or_function: list[Type] | None = None,
	*,
	locals: dict[str, Any] = {},
	cache: bool = False,
	pipeline_class: type | None = None,
...
def jit[R, **P](
	signature_or_function: list[Type] | Callable[P, R] | None = None,
	*,
	locals: dict[str, Any] = {},
	cache: bool = False,
	pipeline_class: type | None = None,
	...
	r"""
	Decorator is used to compile a Python function into native code.
...
def njit(*args: Incomplete, **kws: Incomplete) -> Incomplete:
	"""
...
def cfunc(sig, locals=..., cache: bool = False, pipeline_class=None, **options):
	"""
	Decorator is used to compile a Python function into a C callback usable with foreign C libraries.
