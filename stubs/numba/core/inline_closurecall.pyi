...
from numba.core import (
	cgutils as cgutils, config as config, errors as errors, ir as ir, ir_utils as ir_utils, postproc as postproc,
	rewrites as rewrites, types as types, typing as typing)
from numba.core.analysis import (
	compute_cfg_from_blocks as compute_cfg_from_blocks, compute_live_variables as compute_live_variables,
...
from numba.core.ir_utils import (
	add_offset_to_labels as add_offset_to_labels, canonicalize_array_math as canonicalize_array_math,
	dead_code_elimination as dead_code_elimination, find_build_sequence as find_build_sequence,
	find_callname as find_callname, find_topo_order as find_topo_order, get_definition as get_definition,
	get_ir_of_code as get_ir_of_code, get_np_ufunc_typ as get_np_ufunc_typ, guard as guard,
	GuardException as GuardException, merge_adjacent_blocks as merge_adjacent_blocks, next_label as next_label,
	remove_dels as remove_dels, rename_labels as rename_labels, replace_vars as replace_vars, require as require,
	simplify_CFG as simplify_CFG)
...
class InlineClosureCallPass:
    ...
    typed: Incomplete
    def __init__(self, func_ir, parallel_options, swapped=None, typed: bool = False) -> None: ...
    def run(self):
...
class InlineWorker:
    ...
    def __init__(self, typingctx=None, targetctx=None, locals=None, pipeline=None, flags=None, validator=..., typemap=None, calltypes=None) -> None:
        """
...
def inline_closure_call(func_ir, glbls, block, i, callee, typingctx=None, targetctx=None, arg_typs=None, typemap=None, calltypes=None, work_list=None, callee_validator=None, replace_freevars: bool = True):
