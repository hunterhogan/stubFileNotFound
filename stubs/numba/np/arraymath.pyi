...
from numba.core.errors import (
	NumbaDeprecationWarning as NumbaDeprecationWarning, NumbaNotImplementedError as NumbaNotImplementedError,
	NumbaTypeError as NumbaTypeError, NumbaValueError as NumbaValueError, RequireLiteralValue as RequireLiteralValue,
...
def get_d_impl(x, dx): ...
def np_trapz(y, x=None, dx: float = 1.0): ...
@register_jitable
...
def np_vander(x, N=None, increasing: bool = False): ...
def np_roll(a, shift): ...
...
@register_jitable
def _clip_complex(x): ...
def np_cov(m, y=None, rowvar: bool = True, bias: bool = False, ddof=None): ...
def np_corrcoef(x, y=None, rowvar: bool = True): ...
def np_argwhere(a): ...
...
def impl_np_round(a, decimals: int = 0, out=None): ...
def impl_np_sinc(x): ...
...
def np_bincount(a, weights=None, minlength: int = 0): ...
...
def np_histogram(a, bins: int = 10, range=None): ...
...
def numpy_unwrap(p, discont=None, axis: int = -1, period: float = ...): ...
@register_jitable
