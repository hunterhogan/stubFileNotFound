...
from numba.np.types.datetime import NPDatetime as NPDatetime, NPTimedelta as NPTimedelta
...
def np_trapezoid(y, x=None, dx: float = 1.0): ...
...
def numpy_unwrap(p, discont=None, axis: int = -1, period: float = 6.283185307179586): ...
@register_jitable
