...
def vectorize(ftylist_or_function=(), **kws):
	r"""A decorator that creates a NumPy ufunc object using Numba compiled code.

	When no arguments or only keyword arguments are given,
...
def guvectorize[R, **P](
	...
	*,
	...
	r"""A decorator to create NumPy generalized-ufunc object from Numba compiled code.
